...
function onLoad_1(){
  ...
  instance_4 = ($location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_269() , ($location_0[stackIndex] = 'AsyncLoader3.java:' + '22' , new AsyncLoader3));
...
function $clinit_918(){
  ...
  $location_0[stackIndex] = 'ServerStatusView.java:' + '44' , $clinit_918 = nullMethod;
...
function $ServerStatusView(this$static){
  ...
  $location_0[stackIndex] = 'ServerStatusView.java:' + '59' , $clinit_918();
...
function $provideWidget_0(this$static, callback){
  ...
  this$static.layoutPanel = $MosaicPanel_0(($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , new MosaicPanel), ($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_798() , VERTICAL))));
  console = $HeaderLabel(($location_0[stackIndex] = 'ServerStatusView.java:' + '71' , new HeaderLabel), 'Console Info');
  $add_26(this$static.layoutPanel, console, ($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , $BoxLayoutData_4(($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_800() , HORIZONTAL_0))));
