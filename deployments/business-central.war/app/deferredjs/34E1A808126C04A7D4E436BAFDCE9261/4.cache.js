...
function onLoad_2(){
  ...
  instance_5 = ($location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_270() , ($location_0[stackIndex] = 'AsyncLoader4.java:' + '22' , new AsyncLoader4));
...
function $clinit_489(){
  ...
  $location_0[stackIndex] = 'XMLParser.java:' + '28' , impl_1 = ($location_0[stackIndex] = 'XMLParser.java:' + '28' , $clinit_504() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , $clinit_504()) , impl_2);
  $stackDepth_0 = stackIndex - 1;
}
...
function toString_21(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '246' , $clinit_504() , jsNode = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '95' , this.getJsObject()) , jsNode.xml);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_23(){
  ...
  $location_0[stackIndex] = 'CDATASectionImpl.java:' + '39' , $append_4(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_504() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, ']]>');
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function toString_24(){
  ...
  $location_0[stackIndex] = 'CommentImpl.java:' + '38' , $append_4(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_504() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '-->');
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function toString_26(){
  ...
  returnTemp = ($location_0[stackIndex] = 'ProcessingInstructionImpl.java:' + '63' , $clinit_504() , jsNode = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '95' , this.getJsObject()) , jsNode.xml);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_504(){
  ...
  impl_2 = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '23' , $clinit_505() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '269' , $clinit_504()) , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , new XMLParserImplIE6));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_505(){
  ...
  $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '23' , $clinit_505 = nullMethod;
  $clinit_504();
  $stackDepth_0 = stackIndex - 1;
}
...
function getClass_348(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_348;
  $stackDepth_0 = stackIndex - 1;
...
function $DecoratedTabLayoutPanel_0(this$static, decorateBody){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_728() , TOP), true, decorateBody);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function addMouseDownHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $clinit_168() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_168()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $clinit_170() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_170()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $clinit_172() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_172()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $clinit_176() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_176()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function dragStart_3(){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $add_2(($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $clinit_433() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), glassPanel_1, 0, 0);
...
function $WidgetWindowPanel(this$static, title, widget, overlay){
  ...
  $location_0[stackIndex] = 'WidgetWindowPanel.java:' + '51' , addMaximizeButton(this$static.window_0, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_650() , RIGHT));
...
function getClass_629(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_629;
  $stackDepth_0 = stackIndex - 1;
...
function execute_34(controller, o){
  var view, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_34;
  view = ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '36' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function $initialize(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(dropBox, $DefinitionListView$3(($location_0[stackIndex] = 'DefinitionListView.java:' + '166' , new DefinitionListView$3), this$static, dropBox), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_127() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_127()) , TYPE_0));
...
function getRequestMethod_0(){
  ...
  returnTemp = ($location_0[stackIndex] = 'RequestBuilder.java:' + '70' , $clinit_211() , POST);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleError_0(url, t){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '81' , $clinit_685();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_1(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '62' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function getRequestMethod_2(){
  ...
  returnTemp = ($location_0[stackIndex] = 'RequestBuilder.java:' + '60' , $clinit_211() , GET);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_2(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '40' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_973() , ID_9))), 167), 235));
...
function $parseMessage(this$static, messageDom){
  ...
  try {
    dataSetNode = ($location_0[stackIndex] = 'InstanceDataView.java:' + '130' , ($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , $NodeListImpl(($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , new NodeListImpl), ($clinit_504() , ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '62' , messageDom.jsObject.selectNodes(".//*[local-name()='dataset']"))))).item_1(0));
...
function $createDiagramWindow(this$static, inst){
  ...
  if (this$static.isRiftsawInstance) {
    ...
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , new Event_0), ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_969() , ID_7), inst.id_0)));
  }
   else if (this$static.isjBPMInstance) {
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , VERTICAL))));
    $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '257' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
...
function setController_5(controller){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '308' , $addView(controller, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_956() , ID_2), this.diagramView);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '309' , $addView(controller, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_970() , ID_8), this.instanceDataView);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_996() , ID_11), $LoadActivityDiagramAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '310' , new LoadActivityDiagramAction)));
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_1008() , ID_17), $UpdateInstanceDataAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '314' , new UpdateInstanceDataAction)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_16(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '123' , $equals_4(diagramUrl, ''))) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '144' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_17(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      ...
      $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , new Event_0), ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_996() , ID_11), selection)));
    }
  }
   else {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '169' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_18(clickEvent){
  ...
  if (this.this$0.currentInstance) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '186' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_1008() , ID_17), this.this$0.currentInstance.id_0)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createSignalWindow(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 682, 0, 0, 0));
  layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '565' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '565' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_796() , VERTICAL))));
  $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
  ...
  $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '640' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '640' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '675' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_135() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_135()) , TYPE_3));
...
function $initialize_1(this$static){
  ...
  if (!this$static.isInitialized) {
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '402' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '402' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_798() , HORIZONTAL_0))));
    ...
    $add_26(layout, this$static.instanceList, ($location_0[stackIndex] = 'InstanceListView.java:' + '431' , $BorderLayoutData_1(($location_0[stackIndex] = 'InstanceListView.java:' + '431' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_789() , CENTER_1))));
    detailsView = $InstanceDetailView(($location_0[stackIndex] = 'InstanceListView.java:' + '434' , new InstanceDetailView));
    $location_0[stackIndex] = 'InstanceListView.java:' + '435' , $addView(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_973() , ID_9), detailsView);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1009() , ID_18), ($location_0[stackIndex] = 'InstanceListView.java:' + '436' , new UpdateInstanceDetailAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_957() , ID_3), ($location_0[stackIndex] = 'InstanceListView.java:' + '437' , new ClearInstancesAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1003() , ID_13), $SignalExecutionAction(($location_0[stackIndex] = 'InstanceListView.java:' + '438' , new SignalExecutionAction)));
...
function $renderUpdate(this$static){
  ...
  if (this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '500' , $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '501' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '501' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1009() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '502' , new InstanceEvent), this$static.currentDefinition, null))));
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '318' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED)) {
      $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $clinit_685();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Info', 'Process is already completed');
    }
     else {
      $location_0[stackIndex] = 'InstanceListView.java:' + '303' , $setState_3(selection, ENDED);
      $location_0[stackIndex] = 'InstanceListView.java:' + '304' , $setEndResult(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_949() , OBSOLETE));
      $location_0[stackIndex] = 'InstanceListView.java:' + '305' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '306' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '306' , new Event_0), ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_1006() , ID_15), selection)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '329' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '364' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      ...
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED)) {
        $location_0[stackIndex] = 'InstanceListView.java:' + '343' , $clinit_685();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Info', 'Process is already completed');
      }
       else {
        $location_0[stackIndex] = 'InstanceListView.java:' + '345' , $setState_3(selection, ENDED);
        $location_0[stackIndex] = 'InstanceListView.java:' + '347' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '348' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '348' , new Event_0), ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_968() , ID_6), selection)));
      }
    }
     catch ($e0) {
      ...
      if (instanceOf($e0, 8)) {
        e = $e0;
        $location_0[stackIndex] = 'MessageBox.java:' + '110' , $clinit_685();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '355' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '375' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '381' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '585' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Multi selection', 'Known active nodes and signal ref (text box) is given, please choose only one of them');
  }
   else if (selectedToken != -1) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '590' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '591' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '591' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1003() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '592' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '592' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), dynamicCast($getItem_0(this.this$0.listBoxTokens, selectedToken), 239), ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), selectedToken)))));
  }
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '611' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '612' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '612' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1003() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '613' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '613' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), token, ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), foundMatch)))));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '616' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Incomplete selection', 'Please select element you want to signal');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_25(clickEvent){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '632' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '632' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1010() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_996(){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_996 = nullMethod;
...
function $LoadActivityDiagramAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_996();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '66' , $clinit_685();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Info', 'Process is already completed');
  }
   else {
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_956() , ID_2))), 167), 240));
...
function handleSuccessfulResponse_4(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '54' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_956() , ID_2))), 167), 240));
...
function handleSuccessfulResponse_5(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '71' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function handleError_1(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'StateChangeAction.java:' + '81' , $clinit_685();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_7(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '67' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
...
function getDataDriven_0(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '69' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_958() , ID_4))), 167), 242));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_8(controller, event_0, response){
  ...
  if (isjBPMInstance) {
    view = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_958() , ID_4))), 167), 242));
    if (view) {
...
function $clinit_1008(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_1008 = nullMethod;
...
function $UpdateInstanceDataAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_1008();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '76' , $clinit_685();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_694() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , $clinit_489() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_1, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '65' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_970() , ID_8))), 167), 243));
...
function execute_37(controller, object){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '39' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_973() , ID_9))), 167), 235));
...
function getDataDriven_1(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '68' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_10(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '77' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_979() , ID_10))), 167), 234));
