...
function onClick_17(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '169' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createSignalWindow(this$static){
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '675' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_137() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_137()) , TYPE_3));
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '318' , $clinit_684();
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED)) {
      $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $clinit_684();
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '329' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '364' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      ...
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED)) {
        $location_0[stackIndex] = 'InstanceListView.java:' + '343' , $clinit_684();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Info', 'Process is already completed');
      }
       else {
      ...
      if (instanceOf($e0, 8)) {
        ...
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '355' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '375' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '381' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '585' , $clinit_684();
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '616' , $clinit_684();
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_950() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '66' , $clinit_684();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Info', 'Process is already completed');
  }
   else {
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_956() , ID_2))), 168), 241));
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '76' , $clinit_684();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_693() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , $clinit_489() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_2, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '65' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_970() , ID_8))), 168), 244));
