...
function onLoad_1(){
  ...
  instance_4 = ($location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_267() , ($location_0[stackIndex] = 'AsyncLoader3.java:' + '22' , new AsyncLoader3));
  $location_0[stackIndex] = 'AsyncLoader3.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_61() , BROWSER_LOADER), 3);
...
function $clinit_922(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_922;
  $location_0[stackIndex] = 'ServerStatusView.java:' + '44' , $clinit_922 = nullMethod;
...
function $ServerStatusView(this$static){
  ...
  $location_0[stackIndex] = 'ServerStatusView.java:' + '59' , $clinit_922();
  dynamicCast(($location_0[stackIndex] = 'ServerStatusView.java:' + '61' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  this$static.controller = dynamicCast(($location_0[stackIndex] = 'ServerStatusView.java:' + '62' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 166);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $provideWidget_0(this$static, callback){
  ...
  this$static.layoutPanel = $MosaicPanel_0(($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , new MosaicPanel), ($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  console = $HeaderLabel(($location_0[stackIndex] = 'ServerStatusView.java:' + '71' , new HeaderLabel), 'Console Info');
  $add_26(this$static.layoutPanel, console, ($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , $BoxLayoutData_4(($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  ...
  $add_25(layout1, $HTML_0(($location_0[stackIndex] = 'ServerStatusView.java:' + '76' , new HTML), '2.3.7-DEV'));
  ...
  $add_25(layout2, $HTML_0(($location_0[stackIndex] = 'ServerStatusView.java:' + '86' , new HTML), $getConsoleServerUrl(dynamicCast(get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit), 224).val$config)));
...
function $update_0(this$static, status_0){
  ...
  for ($location_0[stackIndex] = 'ServerStatusView.java:' + '130' , row = 0; row < status_0.plugins.size_0; $location_0[stackIndex] = 'ServerStatusView.java:' + '130' , ++row) {
    p = dynamicCast(($location_0[stackIndex] = 'ServerStatusView.java:' + '132' , $get_6(status_0.plugins, row)), 228);
    ...
    type != null && ($location_0[stackIndex] = 'DOMImplTrident.java:' + '260' , ($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_82() , td).innerText = type || '' , undefined);
