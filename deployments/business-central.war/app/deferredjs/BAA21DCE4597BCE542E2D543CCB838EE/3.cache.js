...
function onLoad_1(){
  ...
  instance_4 = ($location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_266() , ($location_0[stackIndex] = 'AsyncLoader3.java:' + '22' , new AsyncLoader3));
...
function getClass_613(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_613;
  $stackDepth_0 = stackIndex - 1;
