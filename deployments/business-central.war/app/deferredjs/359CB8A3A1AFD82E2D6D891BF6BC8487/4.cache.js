...
function onLoad_2(){
  ...
  instance_5 = ($location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_267() , ($location_0[stackIndex] = 'AsyncLoader4.java:' + '22' , new AsyncLoader4));
...
function $clinit_480(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_480;
  $location_0[stackIndex] = 'XMLParser.java:' + '26' , $clinit_480 = nullMethod;
  $location_0[stackIndex] = 'XMLParser.java:' + '28' , impl_2 = ($location_0[stackIndex] = 'XMLParser.java:' + '28' , $clinit_495() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , $clinit_495()) , impl_3);
  $stackDepth_0 = stackIndex - 1;
}
...
function build(node){
  ...
  $location_0[stackIndex] = 'NodeImpl.java:' + '41' , nodeType = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '141' , $clinit_495() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '142' , out = node.nodeType) , out == null?-1:out);
  switch (nodeType) {
    case 2:
...
function getAttributes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '97' , $NamedNodeMapImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '97' , new NamedNodeMapImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '92' , $clinit_495() , this.jsObject.attributes)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getChildNodes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '101' , $NodeListImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '101' , new NodeListImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '96' , $clinit_495() , this.jsObject.childNodes)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getFirstChild_0(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '105' , ($location_0[stackIndex] = 'NodeImpl.java:' + '101' , $NodeListImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '101' , new NodeListImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '96' , $clinit_495() , this.jsObject.childNodes))).item_1(0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function hasChildNodes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '186' , $clinit_495() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '187' , this.jsObject.hasChildNodes()));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_21(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '246' , $clinit_495() , jsNode = ($location_0[stackIndex] = 'XMLParserImplStandard.java:' + '82' , this.getJsObject()) , ($location_0[stackIndex] = 'XMLParserImplStandard.java:' + '83' , new XMLSerializer).serializeToString(jsNode));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_22(){
  ...
  x = ($location_0[stackIndex] = 'TextImpl.java:' + '48' , $split(($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_495() , this.jsObject.data), '(?=[;&<>\'"])', -1));
...
function toString_23(){
  ...
  $location_0[stackIndex] = 'CDATASectionImpl.java:' + '39' , $append_5(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_495() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBufferImplAppend.java:' + '52' , b.impl.string += ']]>';
  returnTemp = b.impl.string;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function toString_24(){
  ...
  $location_0[stackIndex] = 'CommentImpl.java:' + '38' , $append_5(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_495() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBufferImplAppend.java:' + '52' , b.impl.string += '-->';
  returnTemp = b.impl.string;
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function getLength(){
  ...
  returnTemp = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '117' , $clinit_495() , this.jsObject.length);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_26(){
  ...
  returnTemp = ($location_0[stackIndex] = 'ProcessingInstructionImpl.java:' + '63' , $clinit_495() , jsNode = ($location_0[stackIndex] = 'XMLParserImplStandard.java:' + '82' , this.getJsObject()) , ($location_0[stackIndex] = 'XMLParserImplStandard.java:' + '83' , new XMLSerializer).serializeToString(jsNode));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_495(){
  ...
  $location_0[stackIndex] = 'XMLParserImpl.java:' + '27' , $clinit_495 = nullMethod;
  impl_3 = $XMLParserImplOpera(($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , new XMLParserImplOpera));
  $stackDepth_0 = stackIndex - 1;
}
...
function item_2(t, index){
  ...
  $location_0[stackIndex] = 'XMLParserImpl.java:' + '205' , $clinit_495();
  if (index >= t.length) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $clinit_496(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_496;
  $location_0[stackIndex] = 'XMLParserImplStandard.java:' + '24' , $clinit_496 = nullMethod;
  $clinit_495();
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_497(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_497;
  $location_0[stackIndex] = 'XMLParserImplOpera.java:' + '27' , $clinit_497 = nullMethod;
  $clinit_496();
  $stackDepth_0 = stackIndex - 1;
}
...
function $XMLParserImplOpera(this$static){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $XMLParserImplOpera;
  $location_0[stackIndex] = 'XMLParserImplOpera.java:' + '27' , $clinit_497();
...
function getClass_286(){
  ...
  $stackDepth_0 = stackIndex - 1;
  return Lcom_google_gwt_xml_client_impl_XMLParserImplOpera_2_classLit;
}
...
function $StringTokenizer_0(this$static, string, delimiters, returnDelimiters){
  ...
  if (string != null) {
    ...
    $location_0[stackIndex] = 'StringTokenizer.java:' + '89' , this$static.position = 0;
  }
   else 
...
function $hasMoreTokens(this$static){
  ...
  if (this$static.position < length_0) {
    ...
    for ($location_0[stackIndex] = 'StringTokenizer.java:' + '142' , i = this$static.position; i < length_0; $location_0[stackIndex] = 'StringTokenizer.java:' + '142' , ++i)
...
function $nextToken(this$static){
  ...
  $location_0[stackIndex] = 'StringTokenizer.java:' + '168' , i = this$static.position;
  $location_0[stackIndex] = 'StringTokenizer.java:' + '169' , length_0 = this$static.string.length;
  if (i < length_0) {
    if (this$static.returnDelimiters) {
      if (($location_0[stackIndex] = 'String.java:' + '501' , this$static.delimiters.indexOf(($location_0[stackIndex] = 'String.java:' + '493' , fromCodePoint(($location_0[stackIndex] = 'String.java:' + '419' , this$static.string.charCodeAt(this$static.position)))), 0)) >= 0) {
        returnTemp = ($location_0[stackIndex] = 'String.java:' + '185' , String.fromCharCode(($location_0[stackIndex] = 'String.java:' + '419' , this$static.string.charCodeAt(($location_0[stackIndex] = 'StringTokenizer.java:' + '174' , this$static.position++)))));
        $stackDepth_0 = stackIndex - 1;
        return returnTemp;
      }
      for ($location_0[stackIndex] = 'StringTokenizer.java:' + '175' , ++this$static.position; this$static.position < length_0; $location_0[stackIndex] = 'StringTokenizer.java:' + '175' , ++this$static.position)
        if (($location_0[stackIndex] = 'String.java:' + '501' , this$static.delimiters.indexOf(($location_0[stackIndex] = 'String.java:' + '493' , fromCodePoint(($location_0[stackIndex] = 'String.java:' + '419' , this$static.string.charCodeAt(this$static.position)))), 0)) >= 0) {
          returnTemp = ($location_0[stackIndex] = 'StringTokenizer.java:' + '177' , $substring_0(this$static.string, i, this$static.position));
          $stackDepth_0 = stackIndex - 1;
          return returnTemp;
        }
    ...
    $location_0[stackIndex] = 'StringTokenizer.java:' + '183' , this$static.position = i;
    if (i < length_0) {
      for ($location_0[stackIndex] = 'StringTokenizer.java:' + '185' , ++this$static.position; this$static.position < length_0; $location_0[stackIndex] = 'StringTokenizer.java:' + '185' , ++this$static.position)
        if (($location_0[stackIndex] = 'String.java:' + '501' , this$static.delimiters.indexOf(($location_0[stackIndex] = 'String.java:' + '493' , fromCodePoint(($location_0[stackIndex] = 'String.java:' + '419' , this$static.string.charCodeAt(this$static.position)))), 0)) >= 0) {
          returnTemp = ($location_0[stackIndex] = 'StringTokenizer.java:' + '187' , $substring_0(this$static.string, i, this$static.position));
          $stackDepth_0 = stackIndex - 1;
          return returnTemp;
        }
...
function getClass_349(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_349;
  $stackDepth_0 = stackIndex - 1;
...
function $add_21(this$static, w, tabText){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '330' , $insert_5(this$static, w, tabText, false, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.deck.widget, 182)).children.size_0);
  $stackDepth_0 = stackIndex - 1;
}
...
function $DecoratedTabLayoutPanel_0(this$static, decorateBody){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_719() , TOP), true, decorateBody);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getClass_513(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_513;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_514(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_514;
  $stackDepth_0 = stackIndex - 1;
...
function addMouseDownHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $clinit_165() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_165()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $clinit_167() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_167()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $clinit_169() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_169()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $clinit_173() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_173()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}

function getClass_515(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_515;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_794(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_794;
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '58' , $clinit_794 = nullMethod;
  $clinit_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ColumnLayoutSplitBar$SplitBarDragController(this$static, boundaryPanel, this$0){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '66' , $clinit_794();
...
function dragStart_3(){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $add_2(($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $clinit_425() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), glassPanel_1, 0, 0);
...
function getClass_516(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_516;
  $stackDepth_0 = stackIndex - 1;
...
function $WidgetWindowPanel(this$static, title, widget, overlay){
  ...
  $location_0[stackIndex] = 'WidgetWindowPanel.java:' + '51' , addMaximizeButton(this$static.window_0, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_641() , RIGHT));
...
function getClass_626(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_626;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_627(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_627;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_628(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_628;
  $stackDepth_0 = stackIndex - 1;
...
function parseProcessInstance(root){
  ...
  $location_0[stackIndex] = 'JSOParser.java:' + '88' , suspended = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_507() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , root['suspended']))));
...
function parseTokenReference(rootToken){
  ...
  $location_0[stackIndex] = 'TokenReference.java:' + '112' , tokenReference.canBeSignaled = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_507() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , rootToken['canBeSignaled']))));
...
function $ProcessInstanceRef(this$static, id, processDefinitionId, startDate, endDate, suspended){
  ...
  !!this$static.startDate && !!this$static.endDate?(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '90' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '90' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED), this$static))):!this$static.endDate && this$static.suspended?(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '92' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '92' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , SUSPENDED), this$static))):(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '94' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '94' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , RUNNING), this$static)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $setEndResult(this$static, endResult){
  ...
  if (this$static.lifecycle.current != ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED))
...
function $transitionTo(this$static, next){
  ...
  switch (next.ordinal) {
    case 1:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , RUNNING) == this$static.current) {
    ...
    case 2:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , RUNNING) == this$static.current || SUSPENDED == this$static.current) {
    ...
    case 0:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , SUSPENDED) == this$static.current) {
...
function $clinit_940(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_940;
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_940 = nullMethod;
...
function $ProcessInstanceRef$RESULT(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_940();
...
function getClass_637(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_637;
  $stackDepth_0 = stackIndex - 1;
...
function values_24(){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_940();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_ProcessInstanceRef$RESULT_2_classLit, 707, 108, [COMPLETED, FAILED, ERROR_0, EXITED, OBSOLETE]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
_.getClass$ = getClass_637;
_.typeId$ = 417;
var COMPLETED, ERROR_0, EXITED, FAILED, OBSOLETE;
function $clinit_941(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_941;
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941 = nullMethod;
...
function $ProcessInstanceRef$STATE(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_25(){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_ProcessInstanceRef$STATE_2_classLit, 708, 109, [RUNNING, SUSPENDED, ENDED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $TokenReference(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 681, 0, 0, 0));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $clinit_947(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_947;
  $location_0[stackIndex] = 'ActivityDiagramView.java:' + '39' , $clinit_947 = nullMethod;
...
function $ActivityDiagramView(this$static){
  ...
  $location_0[stackIndex] = 'ActivityDiagramView.java:' + '51' , $clinit_947();
...
function $clinit_948(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_948;
  $location_0[stackIndex] = 'ClearInstancesAction.java:' + '30' , $clinit_948 = nullMethod;
...
function execute_32(controller, o){
  ...
  view = ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '36' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
...
function $clinit_949(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '61' , $clinit_949 = nullMethod;
...
function $initialize(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.definitionList = $MosaicPanel_0(($location_0[stackIndex] = 'DefinitionListView.java:' + '129' , new MosaicPanel), ($location_0[stackIndex] = 'DefinitionListView.java:' + '129' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'DefinitionListView.java:' + '155' , $BoxLayoutData_4(($location_0[stackIndex] = 'DefinitionListView.java:' + '155' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(dropBox, $DefinitionListView$3(($location_0[stackIndex] = 'DefinitionListView.java:' + '166' , new DefinitionListView$3), this$static, dropBox), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_124() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_124()) , TYPE_0));
    ...
    $location_0[stackIndex] = 'DefinitionListView.java:' + '225' , $clinit_1082();
...
function $provideWidget_1(this$static, callback){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '90' , this$static.listBox = ($location_0[stackIndex] = 'DefinitionListView.java:' + '266' , listBox = ($location_0[stackIndex] = 'DefinitionListView.java:' + '267' , $ListBox_1(($location_0[stackIndex] = 'DefinitionListView.java:' + '267' , new ListBox_0), ($location_0[stackIndex] = 'DefinitionListView.java:' + '268' , initValues(_3Ljava_lang_String_2_classLit, 684, 1, ['<b>Process<\/b>', 'v.'])))) , ($location_0[stackIndex] = 'Element.java:' + '134' , listBox.element.focus()) , ($location_0[stackIndex] = 'ListBox.java:' + '716' , listBox.cellRenderer = ($location_0[stackIndex] = 'DefinitionListView.java:' + '275' , new DefinitionListView$7)) , ($location_0[stackIndex] = 'ListBox.java:' + '812' , $setMinimumColumnWidth(listBox.scrollTable, 0, 190)) , ($location_0[stackIndex] = 'ListBox.java:' + '725' , $setColumnResizePolicy_0(listBox.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_821() , MULTI_CELL))) , ($location_0[stackIndex] = 'SelectionGrid.java:' + '248' , $addHandler_1(listBox.scrollTable.dataTable, $DefinitionListView$8(($location_0[stackIndex] = 'DefinitionListView.java:' + '306' , new DefinitionListView$8), this$static, listBox), (!TYPE_24 && (TYPE_24 = $GwtEvent$Type(($location_0[stackIndex] = 'RowSelectionEvent.java:' + '81' , new GwtEvent$Type))) , TYPE_24))) , listBox);
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), $UpdateInstancesAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '94' , new UpdateInstancesAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '40' , $clinit_996() , ID_14), $StartNewInstanceAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '95' , new StartNewInstanceAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_997() , ID_15), $StateChangeAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '96' , new StateChangeAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '37' , $clinit_958() , ID_5), $DeleteDefinitionAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '97' , new DeleteDefinitionAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_959() , ID_6), $DeleteInstanceAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '98' , new DeleteInstanceAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_998() , ID_16), $UpdateDefinitionsAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '99' , new UpdateDefinitionsAction)));
...
function $renderFiltered(this$static){
  ...
  if (this$static.definitions) {
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '351' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '351' , new Event_0), ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_948() , ID_3), null)));
...
function $clinit_950(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '103' , $clinit_950 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $DefinitionListView$1(this$static, val$controller){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '103' , $clinit_950();
...
function run_18(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '108' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '109' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '109' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_998() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_1(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_918() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'DefinitionListView.java:' + '230' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'DefinitionListView.java:' + '233' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_919() , CLASS))), 1), 'deploymentModel') && ($location_0[stackIndex] = 'DefinitionListView.java:' + '246' , addCommand($DefinitionListView$6(($location_0[stackIndex] = 'DefinitionListView.java:' + '247' , new DefinitionListView$6), this.this$0)));
  $stackDepth_0 = stackIndex - 1;
}
...
function execute_33(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '256' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '257' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '257' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_998() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection(rowSelectionEvent){
  ...
  if (index != -1) {
    ...
    $location_0[stackIndex] = 'DefinitionListView.java:' + '322' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '323' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '323' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), item)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_958(){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '35' , $clinit_958 = nullMethod;
...
function $DeleteDefinitionAction(this$static){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '35' , $clinit_958();
...
function handleSuccessfulResponse_0(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '58' , $handleEvent(controller, ($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '59' , $Event(($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '59' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_998() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_959(){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '39' , $clinit_959 = nullMethod;
...
function $DeleteInstanceAction(this$static){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '39' , $clinit_959();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleError_0(url, t){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '81' , $clinit_676();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_1(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '62' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '63' , def = view.currentDefinition;
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '66' , $handleEvent(controller, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '67' , $Event(($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '67' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_960(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_960;
  $location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '17' , $clinit_960 = nullMethod;
...
function $GetProcessInstanceEventsAction(this$static){
  ...
  $location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '17' , $clinit_960();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_2(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '40' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_964() , ID_9))), 167), 235));
...
function $clinit_961(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_961;
  $location_0[stackIndex] = 'InstanceDataView.java:' + '46' , $clinit_961 = nullMethod;
...
function $InstanceDataView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '60' , $clinit_961();
...
function $initialize_0(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.listBox = $ListBox_1(($location_0[stackIndex] = 'InstanceDataView.java:' + '74' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 684, 1, ['Key', 'XSD Type', 'Java Type', 'Value']));
    $location_0[stackIndex] = 'ListBox.java:' + '725' , $setColumnResizePolicy_0(this$static.listBox.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_821() , MULTI_CELL));
...
function $parseMessage(this$static, messageDom){
  ...
  try {
    dataSetNode = ($location_0[stackIndex] = 'InstanceDataView.java:' + '130' , ($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , $NodeListImpl(($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , new NodeListImpl), ($clinit_495() , ($location_0[stackIndex] = 'XMLParserImplStandard.java:' + '46' , messageDom.jsObject.getElementsByTagNameNS('*', 'dataset'))))).item_1(0));
...
function clear_11(){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '69' , $bindData(this, ($location_0[stackIndex] = 'Collections.java:' + '513' , $clinit_562() , EMPTY_LIST));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_964(){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '56' , $clinit_964 = nullMethod;
...
function $InstanceDetailView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '90' , $clinit_964();
  ...
  if (this$static.isRiftsawInstance) {
    ...
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_960() , ID_7), $GetProcessInstanceEventsAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '102' , new GetProcessInstanceEventsAction)));
  }
  $location_0[stackIndex] = 'Element.java:' + '688' , this$static.element['className'] = 'bpm-detail-panel';
  $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '230' , $setLayout_0(this$static.body_0, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '106' , $BoxLayout_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '106' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , HORIZONTAL))));
  this$static.grid = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '108' , $PropertyGrid(($location_0[stackIndex] = 'InstanceDetailView.java:' + '108' , new PropertyGrid), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '109' , initValues(_3Ljava_lang_String_2_classLit, 684, 1, ['Process:', 'Instance ID:', 'State', 'Start Date:', 'Activity:']))));
  $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '91' , $add_26(this$static.body_0, this$static.grid, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '112' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '112' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , BOTH))));
...
function $createDataWindow(this$static, inst){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '69' , $bindData(this$static.instanceDataView, ($location_0[stackIndex] = 'Collections.java:' + '513' , $clinit_562() , EMPTY_LIST));
...
function $createDiagramWindow(this$static, inst){
  ...
  if (this$static.isRiftsawInstance) {
    ...
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
    ...
    this$static.processEvents = $ListBox_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '222' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 684, 1, ['Process Events']));
    ...
    $location_0[stackIndex] = 'TabLayoutPanel.java:' + '330' , $insert_5(tabPanel, sourcePanel, 'Source', false, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(tabPanel.deck.widget, 182)).children.size_0);
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , new Event_0), ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_960() , ID_7), inst.id_0)));
  }
   else if (this$static.isjBPMInstance) {
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
    $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '257' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
...
function $update_5(this$static, def, instance){
  ...
  values = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '325' , initValues(_3Ljava_lang_String_2_classLit, 684, 1, [def.name_0, instance.id_0, '' + instance.lifecycle.current, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '329' , $format_2(this$static.dateFormat, instance.startDate)), currentNodeName]));
...
function setController_5(controller){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '308' , $addView(controller, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_947() , ID_2), this.diagramView);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '309' , $addView(controller, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_961() , ID_8), this.instanceDataView);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_987() , ID_11), $LoadActivityDiagramAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '310' , new LoadActivityDiagramAction)));
  ...
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_999() , ID_17), $UpdateInstanceDataAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '314' , new UpdateInstanceDataAction)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_16(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '123' , $equals_4(diagramUrl, ''))) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '144' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_17(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      ...
      $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , new Event_0), ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_987() , ID_11), selection)));
    }
  }
   else {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '169' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_18(clickEvent){
  ...
  if (this.this$0.currentInstance) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '186' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_999() , ID_17), this.this$0.currentInstance.id_0)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_970(){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '73' , $clinit_970 = nullMethod;
...
function $InstanceListView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '73' , $clinit_970();
...
function $collectSignalableTokens(this$static, tokenParent, tokensToSignal){
  ...
  if (tokenParent.children) {
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '551' , token$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), tokenParent.children); token$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , token$iterator.this$0.size_1());) {
...
function $createSignalWindow(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 681, 0, 0, 0));
  layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '565' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '565' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
  $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
  ...
  $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '640' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '640' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
  ...
  this$static.listBoxTokens = $ListBox_1(($location_0[stackIndex] = 'InstanceListView.java:' + '648' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 684, 1, ['Node name', 'Signal ref']));
  ...
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '675' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_132() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_132()) , TYPE_3));
...
function $initialize_1(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.instanceList = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '146' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '146' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_787() , VERTICAL))));
    ...
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '402' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '402' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_789() , HORIZONTAL_0))));
    ...
    $add_26(layout, this$static.instanceList, ($location_0[stackIndex] = 'InstanceListView.java:' + '431' , $BorderLayoutData_1(($location_0[stackIndex] = 'InstanceListView.java:' + '431' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_780() , CENTER_1))));
    detailsView = $InstanceDetailView(($location_0[stackIndex] = 'InstanceListView.java:' + '434' , new InstanceDetailView));
    $location_0[stackIndex] = 'InstanceListView.java:' + '435' , $addView(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_964() , ID_9), detailsView);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1000() , ID_18), ($location_0[stackIndex] = 'InstanceListView.java:' + '436' , new UpdateInstanceDetailAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_948() , ID_3), ($location_0[stackIndex] = 'InstanceListView.java:' + '437' , new ClearInstancesAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_994() , ID_13), $SignalExecutionAction(($location_0[stackIndex] = 'InstanceListView.java:' + '438' , new SignalExecutionAction)));
...
function $renderUpdate(this$static){
  ...
  if (this$static.isInitialized) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '500' , $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '501' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '501' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1000() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '502' , new InstanceEvent), this$static.currentDefinition, null))));
...
function onRowSelection_0(rowSelectionEvent){
  ...
  if (index != -1) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '196' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '197' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '197' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1000() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '198' , new InstanceEvent), this.this$0.currentDefinition, item))));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_19(clickEvent){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '216' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '217' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '217' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_0(doIt){
  ...
  if (doIt) {
    ...
    if (hasForm) {
      ...
      $location_0[stackIndex] = 'InstanceListView.java:' + '266' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '267' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '267' , new Event_0), ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '40' , $clinit_996() , ID_14), this.this$1.this$0.currentDefinition)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosed(){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '255' , $handleEvent(this.this$2.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '256' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '256' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), this.this$2.this$1.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '318' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED)) {
      $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $clinit_676();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Info', 'Process is already completed');
    }
     else {
      $location_0[stackIndex] = 'InstanceListView.java:' + '303' , $setState_3(selection, ENDED);
      $location_0[stackIndex] = 'InstanceListView.java:' + '304' , $setEndResult(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_940() , OBSOLETE));
      $location_0[stackIndex] = 'InstanceListView.java:' + '305' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '306' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '306' , new Event_0), ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_997() , ID_15), selection)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '329' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '364' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      ...
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED)) {
        $location_0[stackIndex] = 'InstanceListView.java:' + '343' , $clinit_676();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Info', 'Process is already completed');
      }
       else {
        $location_0[stackIndex] = 'InstanceListView.java:' + '345' , $setState_3(selection, ENDED);
        $location_0[stackIndex] = 'InstanceListView.java:' + '347' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '348' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '348' , new Event_0), ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_959() , ID_6), selection)));
      }
    }
     catch ($e0) {
      ...
      if (instanceOf($e0, 8)) {
        e = $e0;
        $location_0[stackIndex] = 'MessageBox.java:' + '110' , $clinit_676();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '355' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '375' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '381' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_24(clickEvent){
  ...
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '585' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Multi selection', 'Known active nodes and signal ref (text box) is given, please choose only one of them');
  }
   else if (selectedToken != -1) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '590' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '591' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '591' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_994() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '592' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '592' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), dynamicCast($getItem_0(this.this$0.listBoxTokens, selectedToken), 239), ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), selectedToken)))));
  }
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '611' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '612' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '612' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_994() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '613' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '613' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), token, ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), foundMatch)))));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '616' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Incomplete selection', 'Please select element you want to signal');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_25(clickEvent){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '632' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '632' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $parseValue(root, key, jsonValue){
  ...
  if ($location_0[stackIndex] = 'JSONTree.java:' + '50' , jsonValue.isBoolean()) {
    ...
    $addItem_2(treeItem, ($location_0[stackIndex] = 'JSONBoolean.java:' + '83' , $clinit_507() , '' + ($location_0[stackIndex] = 'JSONTree.java:' + '53' , jsonValue.isBoolean()).value_0));
  }
...
function $clinit_987(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_987;
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_987 = nullMethod;
...
function $LoadActivityDiagramAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_987();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_3(controller, event_0, response){
  ...
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '66' , $clinit_676();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Info', 'Process is already completed');
  }
   else {
    ...
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_947() , ID_2))), 167), 240));
...
function $clinit_988(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_988;
  $location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '28' , $clinit_988 = nullMethod;
...
function $LoadInstanceActivityImage(this$static){
  ...
  $location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '28' , $clinit_988();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_4(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '54' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_947() , ID_2))), 167), 240));
...
function $provideWidget_3(this$static, callback){
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.panel.element, 'padding', '0px');
  this$static.definitionView = ($location_0[stackIndex] = 'DefinitionListView.java:' + '61' , $clinit_949() , ($location_0[stackIndex] = 'MergedProcessView.java:' + '49' , new DefinitionListView));
...
function $clinit_994(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_994;
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '40' , $clinit_994 = nullMethod;
...
function $SignalExecutionAction(this$static){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '40' , $clinit_994();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_5(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '71' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
...
function $clinit_995(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_995;
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '76' , $clinit_995 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $SignalExecutionAction$1(this$static, val$controller, val$def){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '76' , $clinit_995();
  this$static.val$controller = val$controller;
...
function run_19(){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '82' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '83' , $Event(($location_0[stackIndex] = 'SignalExecutionAction.java:' + '83' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), this.val$def.definition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_996(){
  ...
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '38' , $clinit_996 = nullMethod;
...
function $StartNewInstanceAction(this$static){
  ...
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '38' , $clinit_996();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleSuccessfulResponse_6(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '63' , $handleEvent(controller, ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '64' , $Event(($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '64' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_997(){
  ...
  $location_0[stackIndex] = 'StateChangeAction.java:' + '42' , $clinit_997 = nullMethod;
...
function $StateChangeAction(this$static){
  ...
  $location_0[stackIndex] = 'StateChangeAction.java:' + '42' , $clinit_997();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_9(event_0){
  ...
  if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_941() , ENDED) == inst.lifecycle.current) {
...
function handleError_1(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'StateChangeAction.java:' + '81' , $clinit_676();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_7(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '67' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'StateChangeAction.java:' + '68' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'StateChangeAction.java:' + '71' , $Event(($location_0[stackIndex] = 'StateChangeAction.java:' + '71' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1001() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_998(){
  ...
  $location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '46' , $clinit_998 = nullMethod;
...
function $UpdateDefinitionsAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '46' , $clinit_998();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_0(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '69' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_949() , ID_4))), 167), 242));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_8(controller, event_0, response){
  ...
  if (isjBPMInstance) {
    view = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_949() , ID_4))), 167), 242));
    if (view) {
      ...
      $update_4(view, ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '83' , initValues(_3Ljava_lang_Object_2_classLit, 681, 0, [definitions])));
...
function $clinit_999(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_999 = nullMethod;
...
function $UpdateInstanceDataAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_999();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function handleError_2(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '76' , $clinit_676();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_685() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_9(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , $clinit_480() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_2, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '65' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_961() , ID_8))), 167), 243));
...
function $clinit_1000(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '31' , $clinit_1000 = nullMethod;
...
function execute_35(controller, object){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '39' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_964() , ID_9))), 167), 235));
...
function $clinit_1001(){
  ...
  $location_0[stackIndex] = 'UpdateInstancesAction.java:' + '45' , $clinit_1001 = nullMethod;
...
function $UpdateInstancesAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstancesAction.java:' + '45' , $clinit_1001();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_1(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '68' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_10(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '77' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_7(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_970() , ID_10))), 167), 234));
  !!view && $update_6(view, ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '78' , initValues(_3Ljava_lang_Object_2_classLit, 681, 0, [def, instances])));
  $location_0[stackIndex] = 'Log.java:' + '354' , $clinit_24();
...
function getChildElements(childNodes){
  ...
  for ($location_0[stackIndex] = 'DOMUtil.java:' + '39' , i = 0; i < ($location_0[stackIndex] = 'DOMUtil.java:' + '39' , childNodes.getLength()); $location_0[stackIndex] = 'DOMUtil.java:' + '39' , ++i) {
    ...
    if (($location_0[stackIndex] = 'XMLParserImpl.java:' + '141' , $clinit_495() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '142' , out = n.jsObject.nodeType) , out == null?-1:out) != 1)
      continue;
    else 
