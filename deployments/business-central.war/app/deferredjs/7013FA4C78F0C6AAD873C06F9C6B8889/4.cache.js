...
function onLoad_2(){
  ...
  instance_5 = ($location_0[stackIndex] = 'AsyncLoader4.java:' + '5' , $clinit_271() , ($location_0[stackIndex] = 'AsyncLoader4.java:' + '22' , new AsyncLoader4));
  $location_0[stackIndex] = 'AsyncLoader4.java:' + '23' , $fragmentHasLoaded(($location_0[stackIndex] = 'AsyncFragmentLoader.java:' + '335' , $clinit_61() , BROWSER_LOADER), 4);
...
function $clinit_495(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_495;
  $location_0[stackIndex] = 'XMLParser.java:' + '26' , $clinit_495 = nullMethod;
  $location_0[stackIndex] = 'XMLParser.java:' + '28' , impl_1 = ($location_0[stackIndex] = 'XMLParser.java:' + '28' , $clinit_510() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , $clinit_510()) , impl_2);
  $stackDepth_0 = stackIndex - 1;
}
...
function equals_8(o){
  ...
  if (o != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(o.typeId$, 163))) {
    returnTemp = this.jsObject == ($location_0[stackIndex] = 'DOMItem.java:' + '41' , dynamicCast(o, 163)).jsObject;
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
  $stackDepth_0 = stackIndex - 1;
...
function build(node){
  ...
  $location_0[stackIndex] = 'NodeImpl.java:' + '41' , nodeType = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '141' , $clinit_510() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '142' , out = node.nodeType) , out == null?-1:out);
  switch (nodeType) {
    case 2:
...
function getAttributes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '97' , $NamedNodeMapImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '97' , new NamedNodeMapImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '92' , $clinit_510() , this.jsObject.attributes)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getChildNodes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '101' , $NodeListImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '101' , new NodeListImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '96' , $clinit_510() , this.jsObject.childNodes)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getFirstChild_0(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '105' , ($location_0[stackIndex] = 'NodeImpl.java:' + '101' , $NodeListImpl(($location_0[stackIndex] = 'NodeImpl.java:' + '101' , new NodeListImpl), ($location_0[stackIndex] = 'XMLParserImpl.java:' + '96' , $clinit_510() , this.jsObject.childNodes))).item_1(0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function hasChildNodes(){
  ...
  returnTemp = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '186' , $clinit_510() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '187' , this.jsObject.hasChildNodes()));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_21(){
  ...
  returnTemp = ($location_0[stackIndex] = 'NodeImpl.java:' + '246' , $clinit_510() , jsNode = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '95' , this.getJsObject()) , jsNode.xml);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getClass_275(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_275;
  $stackDepth_0 = stackIndex - 1;
...
function toString_22(){
  ...
  x = ($location_0[stackIndex] = 'TextImpl.java:' + '48' , $split(($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_510() , this.jsObject.data), '(?=[;&<>\'"])', -1));
  for ($location_0[stackIndex] = 'TextImpl.java:' + '49' , i = 0; i < x.length; $location_0[stackIndex] = 'TextImpl.java:' + '49' , ++i) {
    if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '50' , x[i]).indexOf(';')) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&semi;');
      $location_0[stackIndex] = 'TextImpl.java:' + '52' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '52' , x[i]).substr(1, x[i].length - 1)));
    }
     else if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '53' , x[i]).indexOf('&')) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&amp;');
      $location_0[stackIndex] = 'TextImpl.java:' + '55' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '55' , x[i]).substr(1, x[i].length - 1)));
    }
     else if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '56' , x[i]).indexOf('"')) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&quot;');
      $location_0[stackIndex] = 'TextImpl.java:' + '58' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '58' , x[i]).substr(1, x[i].length - 1)));
    }
     else if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '59' , x[i]).indexOf("'")) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&apos;');
      $location_0[stackIndex] = 'TextImpl.java:' + '61' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '61' , x[i]).substr(1, x[i].length - 1)));
    }
     else if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '62' , x[i]).indexOf('<')) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&lt;');
      $location_0[stackIndex] = 'TextImpl.java:' + '64' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '64' , x[i]).substr(1, x[i].length - 1)));
    }
     else if (($location_0[stackIndex] = 'String.java:' + '497' , ($location_0[stackIndex] = 'TextImpl.java:' + '65' , x[i]).indexOf('>')) == 0) {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '&gt;');
      $location_0[stackIndex] = 'TextImpl.java:' + '67' , $append_4(b, ($location_0[stackIndex] = 'String.java:' + '714' , ($location_0[stackIndex] = 'TextImpl.java:' + '67' , x[i]).substr(1, x[i].length - 1)));
    }
     else {
      $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, ($location_0[stackIndex] = 'TextImpl.java:' + '69' , x[i]));
    }
  }
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_23(){
  ...
  $location_0[stackIndex] = 'CDATASectionImpl.java:' + '39' , $append_4(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_510() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, ']]>');
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function toString_24(){
  ...
  $location_0[stackIndex] = 'CommentImpl.java:' + '38' , $append_4(b, ($location_0[stackIndex] = 'XMLParserImpl.java:' + '100' , $clinit_510() , this.jsObject.data));
  $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(b.data_0, '-->');
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function getLength(){
  ...
  returnTemp = ($location_0[stackIndex] = 'XMLParserImpl.java:' + '117' , $clinit_510() , this.jsObject.length);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function toString_25(){
  ...
  for ($location_0[stackIndex] = 'NodeListImpl.java:' + '50' , i = 0; i < ($location_0[stackIndex] = 'NodeListImpl.java:' + '50' , this.getLength()); $location_0[stackIndex] = 'NodeListImpl.java:' + '50' , ++i) {
    $append_4(b, ($location_0[stackIndex] = 'NodeListImpl.java:' + '51' , this.item_1(i)).toString$());
  }
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(b.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
...
function toString_26(){
  ...
  returnTemp = ($location_0[stackIndex] = 'ProcessingInstructionImpl.java:' + '63' , $clinit_510() , jsNode = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '95' , this.getJsObject()) , jsNode.xml);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_510(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_510;
  $location_0[stackIndex] = 'XMLParserImpl.java:' + '27' , $clinit_510 = nullMethod;
  impl_2 = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '23' , $clinit_511() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '269' , $clinit_510()) , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '29' , new XMLParserImplIE6));
  $stackDepth_0 = stackIndex - 1;
}
...
function $parse(this$static, contents){
  ...
  try {
    returnTemp = dynamicCast(build(($location_0[stackIndex] = 'XMLParserImpl.java:' + '278' , $parseImpl(this$static, contents))), 164);
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch ($e0) {
...
function item_2(t, index){
  ...
  $location_0[stackIndex] = 'XMLParserImpl.java:' + '205' , $clinit_510();
  if (index >= t.length) {
    $stackDepth_0 = stackIndex - 1;
    return null;
  }
...
function $clinit_511(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_511;
  $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '23' , $clinit_511 = nullMethod;
  $clinit_510();
  $stackDepth_0 = stackIndex - 1;
}

function $parseImpl(this$static, contents){
  var doc = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '81' , this$static.createDocumentImpl()), stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $parseImpl;
  if (!($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '80' , doc.loadXML(contents))) {
    var err = doc.parseError;
    throw $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '84' , new Error('line ' + err.line + ', char ' + err.linepos + ':' + err.reason);
  }
   else {
    $stackDepth_0 = stackIndex - 1;
    return doc;
...
function createDocumentImpl(){
  var doc = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '43' , selectDOMDocumentVersion()), stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = createDocumentImpl;
  $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '47' , doc.preserveWhiteSpace = true;
  $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '48' , doc.setProperty('SelectionNamespaces', "xmlns:xsl='http://www.w3.org/1999/XSL/Transform'");
  $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '49' , doc.setProperty('SelectionLanguage', 'XPath');
  $stackDepth_0 = stackIndex - 1;
  return doc;
}
...
function selectDOMDocumentVersion(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = selectDOMDocumentVersion;
  try {
    returnTemp = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '32' , new ActiveXObject('Msxml2.DOMDocument'));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch (e) {
  ...
  try {
    returnTemp = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '33' , new ActiveXObject('MSXML.DOMDocument'));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch (e) {
  ...
  try {
    returnTemp = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '34' , new ActiveXObject('MSXML3.DOMDocument'));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch (e) {
  ...
  try {
    returnTemp = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '35' , new ActiveXObject('Microsoft.XmlDom'));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch (e) {
  ...
  try {
    returnTemp = ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '36' , new ActiveXObject('Microsoft.DOMDocument'));
    $stackDepth_0 = stackIndex - 1;
    return returnTemp;
  }
   catch (e) {
  }
  throw $location_0[stackIndex] = 'XMLParserImplIE6.java:' + '38' , new Error('XMLParserImplIE6.createDocumentImpl: Could not find appropriate version of DOMDocument.');
}
...
function $add_21(this$static, w, tabText){
  ...
  $location_0[stackIndex] = 'TabLayoutPanel.java:' + '330' , $insert_5(this$static, w, tabText, false, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(this$static.deck.widget, 182)).children_0.size_0);
  $stackDepth_0 = stackIndex - 1;
}
...
function $DecoratedTabLayoutPanel_0(this$static, decorateBody){
  ...
  $location_0[stackIndex] = 'DecoratedTabLayoutPanel.java:' + '39' , $TabLayoutPanel(this$static, ($location_0[stackIndex] = 'TabLayoutPanel.java:' + '65' , $clinit_734() , TOP), true, decorateBody);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $ToolBarSeparator(this$static){
  ...
  $location_0[stackIndex] = 'UIObject.java:' + '799' , this$static.element = $createElement(($location_0[stackIndex] = 'Document.java:' + '930' , $clinit_82() , $doc), 'span');
...
function $getLayoutData_1(child){
  ...
  if (layoutDataObject == null || !(layoutDataObject != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(layoutDataObject.typeId$, 205)))) {
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayout.java:' + '255' , dynamicCast(layoutDataObject, 205));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $init_9(this$static, layoutPanel){
  ...
  for ($location_0[stackIndex] = 'ColumnLayout.java:' + '266' , iter = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.visibleChildList); iter.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , iter.this$0.size_1());) {
    ...
    if (widget != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(widget.typeId$, 206))) {
...
function getClass_517(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_517;
  $stackDepth_0 = stackIndex - 1;
...
function getPreferredSize_7(layoutPanel){
  ...
  try {
    ...
    for ($location_0[stackIndex] = 'ColumnLayout.java:' + '75' , child$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.visibleChildList); child$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , child$iterator.this$0.size_1());) {
      ...
      child != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(child.typeId$, 201)) && (child = ($location_0[stackIndex] = 'ColumnLayout.java:' + '77' , dynamicCast(child, 201)).widget_0);
      ...
      if (parent_0 != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(parent_0.typeId$, 201))) {
        decPanel = ($location_0[stackIndex] = 'ColumnLayout.java:' + '82' , dynamicCast(parent_0, 201));
...
function layoutPanel_6(layoutPanel){
  ...
  try {
    ...
    for ($location_0[stackIndex] = 'ColumnLayout.java:' + '147' , child$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.visibleChildList); child$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , child$iterator.this$0.size_1());) {
      ...
      child != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(child.typeId$, 201)) && (child = ($location_0[stackIndex] = 'ColumnLayout.java:' + '149' , dynamicCast(child, 201)).widget_0);
      ...
      if (parent_0 != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(parent_0.typeId$, 201))) {
        decPanel = ($location_0[stackIndex] = 'ColumnLayout.java:' + '156' , dynamicCast(parent_0, 201));
      ...
      if (!layoutData.preferredWidth) {
        ...
        parent_0 != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(parent_0.typeId$, 201)) && ($location_0[stackIndex] = 'ColumnLayout.java:' + '167' , layoutData.calcWidth += decPanelFrameSize.width_0);
    ...
    for ($location_0[stackIndex] = 'ColumnLayout.java:' + '174' , i = 0 , n = this.visibleChildList.size_0; i < n; $location_0[stackIndex] = 'ColumnLayout.java:' + '174' , ++i) {
      child = dynamicCast(($location_0[stackIndex] = 'ColumnLayout.java:' + '175' , $get_6(this.visibleChildList, i)), 2);
      child != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(child.typeId$, 201)) && (child = ($location_0[stackIndex] = 'ColumnLayout.java:' + '178' , dynamicCast(child, 201)).widget_0);
      layoutData = ($location_0[stackIndex] = 'ColumnLayout.java:' + '181' , dynamicCast(child.layoutData, 205));
      ...
      if (parent_0 != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(parent_0.typeId$, 201))) {
        $location_0[stackIndex] = 'ColumnLayout.java:' + '195' , dynamicCast(parent_0, 201);
      ...
      if (i < n - 1) {
        if (!layoutData.splitBar || layoutPanel != layoutData.splitBar.dragController.boundaryPanel) {
          layoutData.splitBar = ($location_0[stackIndex] = 'ColumnLayout.java:' + '210' , $ColumnLayoutSplitBar(($location_0[stackIndex] = 'ColumnLayout.java:' + '210' , new ColumnLayoutSplitBar), layoutPanel, child, dynamicCast(($location_0[stackIndex] = 'ColumnLayout.java:' + '211' , $get_6(this.visibleChildList, i + 1)), 2)));
        ...
        layoutData.splitBar.widgetR = dynamicCast(($location_0[stackIndex] = 'ColumnLayout.java:' + '220' , $get_6(this.visibleChildList, i + 1)), 2);
      ...
      if (layoutPanel.animationEnabled) {
        $location_0[stackIndex] = 'ColumnLayout.java:' + '229' , $setSourceLeft(layoutData, $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , child.element)) - $getAbsoluteLeft_0(layoutPanel.element) - ($location_0[stackIndex] = 'BaseLayout.java:' + '620' , $getPaddingSize_0(this.paddingLeftMeasure.cache, layoutPanel)).top_0);
...
function getClass_518(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_518;
  $stackDepth_0 = stackIndex - 1;
...
function addMouseDownHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '167' , $clinit_169() , ($location_0[stackIndex] = 'MouseDownEvent.java:' + '27' , $clinit_169()) , TYPE_7)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseMoveHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '171' , $clinit_171() , ($location_0[stackIndex] = 'MouseMoveEvent.java:' + '27' , $clinit_171()) , TYPE_8)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseOutHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '175' , $clinit_173() , ($location_0[stackIndex] = 'MouseOutEvent.java:' + '29' , $clinit_173()) , TYPE_9)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function addMouseUpHandler_7(handler){
  ...
  returnTemp = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $addDomHandler(this, handler, ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '183' , $clinit_177() , ($location_0[stackIndex] = 'MouseUpEvent.java:' + '27' , $clinit_177()) , TYPE_11)));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_809(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_809;
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '58' , $clinit_809 = nullMethod;
  $clinit_0();
  $stackDepth_0 = stackIndex - 1;
}
...
function $ColumnLayoutSplitBar$SplitBarDragController(this$static, boundaryPanel, this$0){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '66' , $clinit_809();
...
function dragEnd_3(){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '109' , delta = $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , this.context.draggable.element)) - this.draggableOldAbsoluteLeft;
  ...
  layoutDataL = ($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '125' , dynamicCast(this.this$0.widgetL.layoutData, 205));
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '128' , $setPreferredWidth(layoutDataL, sizeL + 'px');
  $location_0[stackIndex] = 'AbstractDragController.java:' + '123' , $removeStyleName(this.context.draggable, (!css_0 && (css_0 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_dnd_client_util_DragClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_dnd_client_util_DragClientBundle_default_StaticClientBundleGenerator$1)) , 'dragdrop-dragging'));
...
function dragMove_2(){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '103' , fastSetElementPosition(this.movablePanel.element, desiredLeft, $getAbsoluteTop_0(($location_0[stackIndex] = 'Element.java:' + '166' , $clinit_82() , this.context.draggable.element)) - this.boundaryOffsetY);
  $stackDepth_0 = stackIndex - 1;
}
...
function dragStart_3(){
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $add_2(($location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '76' , $clinit_436() , ($location_0[stackIndex] = 'RootPanel.java:' + '151' , get_1(null))), glassPanel_1, 0, 0);
  $location_0[stackIndex] = 'AbstractDragController.java:' + '147' , $addStyleName(this.context.draggable, (!css_0 && (css_0 = ($location_0[stackIndex] = 'com_allen_sauer_gwt_dnd_client_util_DragClientBundle_default_StaticClientBundleGenerator.java:' + '9' , new com_allen_sauer_gwt_dnd_client_util_DragClientBundle_default_StaticClientBundleGenerator$1)) , 'dragdrop-dragging'));
  ...
  $location_0[stackIndex] = 'ColumnLayoutSplitBar.java:' + '96' , this.draggableOldAbsoluteLeft = $getAbsoluteLeft_0(($location_0[stackIndex] = 'Element.java:' + '150' , $clinit_82() , this.context.draggable.element));
  $stackDepth_0 = stackIndex - 1;
}
...
function $WidgetWindowPanel(this$static, title, widget, overlay){
  ...
  $location_0[stackIndex] = 'WidgetWindowPanel.java:' + '51' , addMaximizeButton(this$static.window_0, ($location_0[stackIndex] = 'Caption.java:' + '61' , $clinit_656() , RIGHT));
...
function getClass_630(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_630;
  $stackDepth_0 = stackIndex - 1;
...
function parseActiveNodeInfo(json){
  ...
  if (root != null && ($location_0[stackIndex] = 'Cast.java:' + '76' , canCast(root.typeId$, 138))) {
    array = ($location_0[stackIndex] = 'DTOParser.java:' + '353' , dynamicCast(root, 138));
    for ($location_0[stackIndex] = 'DTOParser.java:' + '355' , i = 0; i < array.jsArray.length; $location_0[stackIndex] = 'DTOParser.java:' + '355' , ++i) {
      $location_0[stackIndex] = 'DTOParser.java:' + '356' , walk = ($location_0[stackIndex] = 'JSONWalk.java:' + '48' , $JSONWalk(($location_0[stackIndex] = 'JSONWalk.java:' + '48' , new JSONWalk), ($location_0[stackIndex] = 'DTOParser.java:' + '356' , $get_3(array, i))));
...
function getClass_632(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_632;
  $stackDepth_0 = stackIndex - 1;
...
function parseProcessInstance(root){
  ...
  $location_0[stackIndex] = 'JSOParser.java:' + '88' , suspended = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_521() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , root['suspended']))));
...
function parseTokenReference(rootToken){
  ...
  $location_0[stackIndex] = 'TokenReference.java:' + '112' , tokenReference.canBeSignaled = ($location_0[stackIndex] = 'JSOModel.java:' + '112' , $clinit_521() , ($location_0[stackIndex] = 'Boolean.java:' + '35' , $equalsIgnoreCase('true', '' + ($location_0[stackIndex] = 'JSOModel.java:' + '96' , rootToken['canBeSignaled']))));
  ...
  if (tokenChildrenJson) {
    ...
    $location_0[stackIndex] = 'TokenReference.java:' + '72' , tokenReference.children_0 = children;
  }
...
function $ProcessInstanceRef(this$static, id, processDefinitionId, startDate, endDate, suspended){
  ...
  !!this$static.startDate && !!this$static.endDate?(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '90' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '90' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED), this$static))):!this$static.endDate && this$static.suspended?(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '92' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '92' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , SUSPENDED), this$static))):(this$static.lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '94' , $ProcessInstanceRef$Lifecycle(($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '94' , new ProcessInstanceRef$Lifecycle), this$static, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , RUNNING), this$static)));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $setEndResult(this$static, endResult){
  ...
  if (this$static.lifecycle.current != ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED))
...
function equals_35(o){
  ...
  that = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '312' , dynamicCast(o, 231));
...
function getClass_638(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_638;
  $stackDepth_0 = stackIndex - 1;
...
function getClass_639(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_639;
  $stackDepth_0 = stackIndex - 1;
...
function $transitionTo(this$static, next){
  ...
  switch (next.ordinal) {
    case 1:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , RUNNING) == this$static.current) {
    ...
    case 2:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , RUNNING) == this$static.current || SUSPENDED == this$static.current) {
    ...
    case 0:
      if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , SUSPENDED) == this$static.current) {
...
function equals_36(o){
  ...
  lifecycle = ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '253' , dynamicCast(o, 232));
...
function getClass_640(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_640;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_955(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_955;
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_955 = nullMethod;
...
function $ProcessInstanceRef$RESULT(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_955();
...
function values_24(){
  var stackIndex, returnTemp;
  $stack_0[stackIndex = ++$stackDepth_0] = values_24;
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_955();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_ProcessInstanceRef$RESULT_2_classLit, 710, 108, [COMPLETED, FAILED, ERROR_0, EXITED, OBSOLETE]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $clinit_956(){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956 = nullMethod;
...
function $ProcessInstanceRef$STATE(this$static, enum$name, enum$ordinal){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956();
  $location_0[stackIndex] = 'Enum.java:' + '76' , this$static.name_0 = enum$name;
  $location_0[stackIndex] = 'Enum.java:' + '77' , this$static.ordinal = enum$ordinal;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
...
function values_25(){
  ...
  $location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956();
  returnTemp = initValues(_3Lorg_jboss_bpm_console_client_model_ProcessInstanceRef$STATE_2_classLit, 711, 109, [RUNNING, SUSPENDED, ENDED]);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $TokenReference(this$static){
  ...
  this$static.children_0 = $ArrayList(($location_0[stackIndex] = 'TokenReference.java:' + '39' , new ArrayList));
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 684, 0, 0, 0));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_647(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_647;
  $stackDepth_0 = stackIndex - 1;
...
function $clinit_962(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_962;
  $location_0[stackIndex] = 'ActivityDiagramView.java:' + '39' , $clinit_962 = nullMethod;
...
function $ActivityDiagramView(this$static){
  ...
  $location_0[stackIndex] = 'ActivityDiagramView.java:' + '51' , $clinit_962();
  $ScrollLayoutPanel_0(this$static, ($location_0[stackIndex] = 'ScrollLayoutPanel.java:' + '52' , $BoxLayout_1(($location_0[stackIndex] = 'ScrollLayoutPanel.java:' + '52' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $update_2(this$static, event_0){
  ...
  for ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '77' , activeNodeInfo$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), activeNodeInfos); activeNodeInfo$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , activeNodeInfo$iterator.this$0.size_1());) {
    activeNodeInfo = dynamicCast(($location_0[stackIndex] = 'ActivityDiagramView.java:' + '77' , $next_6(activeNodeInfo$iterator)), 233);
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(this$static, html, this$static.children_0.size_0);
...
function $clinit_963(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_963;
  $location_0[stackIndex] = 'ClearInstancesAction.java:' + '30' , $clinit_963 = nullMethod;
...
function execute_35(controller, o){
  var view, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = execute_35;
  view = ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '36' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'InstanceListView.java:' + '468' , view.currentDefinition = null;
  view.cachedInstances = $ArrayList(($location_0[stackIndex] = 'InstanceListView.java:' + '469' , new ArrayList));
  $location_0[stackIndex] = 'InstanceListView.java:' + '470' , $renderUpdate(view);
...
function getClass_649(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_649;
  $stackDepth_0 = stackIndex - 1;
...
_.execute_2 = execute_35;
_.getClass$ = getClass_649;
_.typeId$ = 427;
var ID_3;
function $clinit_964(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_964;
  $location_0[stackIndex] = 'DefinitionListView.java:' + '61' , $clinit_964 = nullMethod;
...
function $initialize(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.definitionList = $MosaicPanel_0(($location_0[stackIndex] = 'DefinitionListView.java:' + '129' , new MosaicPanel), ($location_0[stackIndex] = 'DefinitionListView.java:' + '129' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    ...
    $location_0[stackIndex] = 'DefinitionListView.java:' + '150' , $add_28(toolBar, $Button_1(($location_0[stackIndex] = 'DefinitionListView.java:' + '151' , new Button), 'Refresh', clickHandler));
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'DefinitionListView.java:' + '155' , $BoxLayoutData_4(($location_0[stackIndex] = 'DefinitionListView.java:' + '155' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    ...
    $location_0[stackIndex] = 'ListBox.java:' + '104' , $addDomHandler(dropBox, $DefinitionListView$3(($location_0[stackIndex] = 'DefinitionListView.java:' + '166' , new DefinitionListView$3), this$static, dropBox), ($location_0[stackIndex] = 'ListBox.java:' + '104' , $clinit_128() , ($location_0[stackIndex] = 'ChangeEvent.java:' + '27' , $clinit_128()) , TYPE_0));
    $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(filterPanel, dropBox, filterPanel.children_0.size_0);
    ...
    $location_0[stackIndex] = 'DefinitionListView.java:' + '225' , $clinit_1097();
...
function $provideWidget_1(this$static, callback){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '90' , this$static.listBox = ($location_0[stackIndex] = 'DefinitionListView.java:' + '266' , listBox = ($location_0[stackIndex] = 'DefinitionListView.java:' + '267' , $ListBox_1(($location_0[stackIndex] = 'DefinitionListView.java:' + '267' , new ListBox_0), ($location_0[stackIndex] = 'DefinitionListView.java:' + '268' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['<b>Process<\/b>', 'v.'])))) , ($location_0[stackIndex] = 'ListBox.java:' + '769' , $focus(listBox.element)) , ($location_0[stackIndex] = 'ListBox.java:' + '716' , listBox.cellRenderer = ($location_0[stackIndex] = 'DefinitionListView.java:' + '275' , new DefinitionListView$7)) , ($location_0[stackIndex] = 'ListBox.java:' + '812' , $setMinimumColumnWidth(listBox.scrollTable, 0, 190)) , ($location_0[stackIndex] = 'ListBox.java:' + '725' , $setColumnResizePolicy_0(listBox.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_836() , MULTI_CELL))) , ($location_0[stackIndex] = 'SelectionGrid.java:' + '248' , $addHandler_1(listBox.scrollTable.dataTable, $DefinitionListView$8(($location_0[stackIndex] = 'DefinitionListView.java:' + '306' , new DefinitionListView$8), this$static, listBox), (!TYPE_24 && (TYPE_24 = $GwtEvent$Type(($location_0[stackIndex] = 'RowSelectionEvent.java:' + '81' , new GwtEvent$Type))) , TYPE_24))) , listBox);
  controller = dynamicCast(($location_0[stackIndex] = 'DefinitionListView.java:' + '91' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 166);
  $location_0[stackIndex] = 'DefinitionListView.java:' + '92' , $addView(controller, ID_4, this$static);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), $UpdateInstancesAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '94' , new UpdateInstancesAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '40' , $clinit_1011() , ID_14), $StartNewInstanceAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '95' , new StartNewInstanceAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_1012() , ID_15), $StateChangeAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '96' , new StateChangeAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '37' , $clinit_973() , ID_5), $DeleteDefinitionAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '97' , new DeleteDefinitionAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_974() , ID_6), $DeleteInstanceAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '98' , new DeleteInstanceAction)));
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_1013() , ID_16), $UpdateDefinitionsAction(($location_0[stackIndex] = 'DefinitionListView.java:' + '99' , new UpdateDefinitionsAction)));
...
function $renderFiltered(this$static){
  ...
  if (this$static.definitions) {
    ...
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '351' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '351' , new Event_0), ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_963() , ID_3), null)));
    ...
    for (def$iterator = ($location_0[stackIndex] = 'DefinitionListView.java:' + '382' , this$static.definitions.iterator_0()); $location_0[stackIndex] = 'DefinitionListView.java:' + '382' , def$iterator.hasNext();) {
      def = dynamicCast(def$iterator.next_0(), 230);
...
function $update_4(this$static, data){
  ...
  this$static.definitions = dynamicCast(($location_0[stackIndex] = 'DefinitionListView.java:' + '362' , data[0]), 170);
...
function getClass_650(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_650;
  $stackDepth_0 = stackIndex - 1;
...
_.getClass$ = getClass_650;
_.setController = setController_3;
_.setLoading = setLoading;
var ID_4;
function $clinit_965(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_965;
  $location_0[stackIndex] = 'DefinitionListView.java:' + '103' , $clinit_965 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $DefinitionListView$1(this$static, val$controller){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '103' , $clinit_965();
...
function run_18(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '108' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '109' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '109' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_1013() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function callback_1(message){
  ...
  ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , $clinit_933() , ($location_0[stackIndex] = 'ModelCommands.java:' + '24' , valueOf_0(enum$map, ($location_0[stackIndex] = 'DefinitionListView.java:' + '230' , message.getCommandType())))).ordinal == 1 && $equals_4(dynamicCast(($location_0[stackIndex] = 'DefinitionListView.java:' + '233' , message.get_2(Ljava_lang_String_2_classLit, ($location_0[stackIndex] = 'ModelParts.java:' + '27' , $clinit_934() , CLASS))), 1), 'deploymentModel') && ($location_0[stackIndex] = 'DefinitionListView.java:' + '246' , addCommand($DefinitionListView$6(($location_0[stackIndex] = 'DefinitionListView.java:' + '247' , new DefinitionListView$6), this.this$0)));
  $stackDepth_0 = stackIndex - 1;
}
...
function execute_36(){
  ...
  $location_0[stackIndex] = 'DefinitionListView.java:' + '256' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '257' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '257' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_1013() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell(listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      ...
      break;
    case 1:
      $location_0[stackIndex] = 'DefinitionListView.java:' + '291' , $setText_6(listBox, row, column, '' + ($location_0[stackIndex] = 'ProcessDefinitionRef.java:' + '81' , toString_18(item.version)));
      break;
    case 2:
      $location_0[stackIndex] = 'DefinitionListView.java:' + '294' , $setText_6(listBox, row, column, '' + item.suspended);
      break;
...
function renderCell_0(p0, p1, p2, p3){
  ...
  $renderCell(p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 230)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection(rowSelectionEvent){
  ...
  if (index != -1) {
    item = dynamicCast(($location_0[stackIndex] = 'DefinitionListView.java:' + '313' , $getItem_0(this.val$listBox, index)), 230);
    $location_0[stackIndex] = 'DefinitionListView.java:' + '322' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'DefinitionListView.java:' + '323' , $Event(($location_0[stackIndex] = 'DefinitionListView.java:' + '323' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), item)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_973(){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '35' , $clinit_973 = nullMethod;
...
function $DeleteDefinitionAction(this$static){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '35' , $clinit_973();
...
function getRequestMethod_0(){
  ...
  returnTemp = ($location_0[stackIndex] = 'RequestBuilder.java:' + '70' , $clinit_212() , POST);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getUrl_2(event_0){
  ...
  procRef = ($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '46' , dynamicCast(event_0, 230));
...
function handleSuccessfulResponse_0(controller, event_0, response){
  ...
  $location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '58' , $handleEvent(controller, ($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '59' , $Event(($location_0[stackIndex] = 'DeleteDefinitionAction.java:' + '59' , new Event_0), ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '48' , $clinit_1013() , ID_16), null)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_974(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_974;
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '39' , $clinit_974 = nullMethod;
...
function $DeleteInstanceAction(this$static){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '39' , $clinit_974();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_3(event_0){
  ...
  instance = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '51' , dynamicCast(event_0, 231));
...
function handleError_0(url, t){
  ...
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '81' , $clinit_691();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_1(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '62' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '63' , def = view.currentDefinition;
  $location_0[stackIndex] = 'DeleteInstanceAction.java:' + '66' , $handleEvent(controller, ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '67' , $Event(($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '67' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_975(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_975;
  $location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '17' , $clinit_975 = nullMethod;
...
function $GetProcessInstanceEventsAction(this$static){
  ...
  $location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '17' , $clinit_975();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getRequestMethod_2(){
  ...
  returnTemp = ($location_0[stackIndex] = 'RequestBuilder.java:' + '60' , $clinit_212() , GET);
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_2(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '40' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9))), 167), 235));
...
function $clinit_976(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_976;
  $location_0[stackIndex] = 'InstanceDataView.java:' + '46' , $clinit_976 = nullMethod;
...
function $InstanceDataView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '60' , $clinit_976();
  ...
  appContext = dynamicCast(($location_0[stackIndex] = 'InstanceDataView.java:' + '63' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
...
function $bindData(this$static, data){
  ...
  for (d$iterator = ($location_0[stackIndex] = 'InstanceDataView.java:' + '182' , data.iterator_0()); $location_0[stackIndex] = 'InstanceDataView.java:' + '182' , d$iterator.hasNext();) {
    d = dynamicCast(d$iterator.next_0(), 237);
...
function $initialize_0(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.listBox = $ListBox_1(($location_0[stackIndex] = 'InstanceDataView.java:' + '74' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Key', 'XSD Type', 'Java Type', 'Value']));
    $location_0[stackIndex] = 'ListBox.java:' + '725' , $setColumnResizePolicy_0(this$static.listBox.scrollTable, ($location_0[stackIndex] = 'AbstractScrollTable.java:' + '823' , $clinit_836() , MULTI_CELL));
...
function $parseMessage(this$static, messageDom){
  ...
  try {
    dataSetNode = ($location_0[stackIndex] = 'InstanceDataView.java:' + '130' , ($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , $NodeListImpl(($location_0[stackIndex] = 'DocumentImpl.java:' + '140' , new NodeListImpl), ($clinit_510() , ($location_0[stackIndex] = 'XMLParserImplIE6.java:' + '62' , messageDom.jsObject.selectNodes(".//*[local-name()='dataset']"))))).item_1(0));
    ...
    for ($location_0[stackIndex] = 'InstanceDataView.java:' + '136' , dataNode$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), dataSetNodeChildren); dataNode$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , dataNode$iterator.this$0.size_1());) {
      dataNode = dynamicCast(($location_0[stackIndex] = 'InstanceDataView.java:' + '136' , $next_6(dataNode$iterator)), 236);
      ...
      valueNode = dynamicCast($get_6(($location_0[stackIndex] = 'InstanceDataView.java:' + '140' , getChildElements(($location_0[stackIndex] = 'InstanceDataView.java:' + '141' , dataNode.getChildNodes()))), 0), 236);
...
function clear_11(){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '69' , $bindData(this, ($location_0[stackIndex] = 'Collections.java:' + '513' , $clinit_576() , EMPTY_LIST));
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell_0(this$static, listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'InstanceDataView.java:' + '84' , $setText_6(listBox, row, column, item.key);
      break;
    case 1:
      $location_0[stackIndex] = 'InstanceDataView.java:' + '87' , $setText_6(listBox, row, column, item.xsd);
      break;
    case 2:
      $location_0[stackIndex] = 'InstanceDataView.java:' + '90' , $setText_6(listBox, row, column, item.java_0);
      break;
    case 3:
      if (this$static.this$0.isRiftsawInstance) {
        ...
        $location_0[stackIndex] = 'ListBox.java:' + '921' , $setWidget_9(listBox.dataTable, (trElem = dynamicCastJso(($location_0[stackIndex] = 'ListBox.java:' + '925' , $get_6(listBox.rowsInModelOrder, row))) , trElem.sectionRowIndex - 1), column, tree);
      }
       else {
        $location_0[stackIndex] = 'InstanceDataView.java:' + '97' , $setText_6(listBox, row, column, item.value_0);
      }
...
function renderCell_1(p0, p1, p2, p3){
  ...
  $renderCell_0(this, p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 237)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_979(){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '56' , $clinit_979 = nullMethod;
...
function $InstanceDetailView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '90' , $clinit_979();
  ...
  this$static.appContext = dynamicCast(($location_0[stackIndex] = 'InstanceDetailView.java:' + '94' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  ...
  if (this$static.isRiftsawInstance) {
    this$static.controller = dynamicCast(($location_0[stackIndex] = 'InstanceDetailView.java:' + '100' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 166);
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '101' , $addView(this$static.controller, ID_9, this$static);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_975() , ID_7), $GetProcessInstanceEventsAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '102' , new GetProcessInstanceEventsAction)));
  }
  $location_0[stackIndex] = 'Element.java:' + '688' , this$static.element['className'] = 'bpm-detail-panel';
  $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '230' , $setLayout_0(this$static.body_0, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '106' , $BoxLayout_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '106' , new BoxLayout), ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , HORIZONTAL))));
  this$static.grid = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '108' , $PropertyGrid(($location_0[stackIndex] = 'InstanceDetailView.java:' + '108' , new PropertyGrid), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '109' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Process:', 'Instance ID:', 'State', 'Start Date:', 'Activity:']))));
  $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '91' , $add_26(this$static.body_0, this$static.grid, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '112' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '112' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , BOTH))));
  ...
  if (this$static.isRiftsawInstance) {
    this$static.diagramBtn = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '117' , $Button_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '117' , new Button), 'Execution Path', $InstanceDetailView$1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '118' , new InstanceDetailView$1), this$static)));
  }
   else if (this$static.isjBPMInstance) {
    this$static.diagramBtn = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '150' , $Button_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '150' , new Button), 'Diagram', $InstanceDetailView$2(($location_0[stackIndex] = 'InstanceDetailView.java:' + '151' , new InstanceDetailView$2), this$static)));
  ...
  $add_26(buttonPanel, this$static.diagramBtn, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '177' , new BoxLayoutData), HORIZONTAL_0));
  this$static.instanceDataBtn = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '178' , $Button_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '178' , new Button), 'Instance Data', $InstanceDetailView$3(($location_0[stackIndex] = 'InstanceDetailView.java:' + '179' , new InstanceDetailView$3), this$static)));
  $location_0[stackIndex] = 'Element.java:' + '638' , this$static.instanceDataBtn.element['disabled'] = !false;
  $add_26(buttonPanel, this$static.instanceDataBtn, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '194' , new BoxLayoutData), HORIZONTAL_0));
  $location_0[stackIndex] = 'CaptionLayoutPanel.java:' + '81' , $add_25(this$static.body_0, buttonPanel);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '198' , this$static.hasDiagramPlugin = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '199' , has('org.jboss.bpm.console.server.plugin.GraphViewerPlugin'));
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function $createDataWindow(this$static, inst){
  ...
  $location_0[stackIndex] = 'InstanceDataView.java:' + '69' , $bindData(this$static.instanceDataView, ($location_0[stackIndex] = 'Collections.java:' + '513' , $clinit_576() , EMPTY_LIST));
  $WidgetWindowPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '295' , new WidgetWindowPanel), 'Process Instance Data: ' + inst.id_0, this$static.instanceDataView, true);
  $stackDepth_0 = stackIndex - 1;
}
...
function $createDiagramWindow(this$static, inst){
  ...
  if (this$static.isRiftsawInstance) {
    layout = $ScrollLayoutPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '206' , new ScrollLayoutPanel));
    ...
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '210' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '212' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    tabPanel = $DecoratedTabLayoutPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '214' , new DecoratedTabLayoutPanel), false);
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(tabPanel.deck.widget, 182)).element, 'padding', '5px');
    diaViewLayout = $MosaicPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '217' , new MosaicPanel));
    $add_26(diaViewLayout, this$static.diagramView, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '218' , new BoxLayoutData), HORIZONTAL_0));
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '220' , $add_21(tabPanel, this$static.diagramView, 'View');
    this$static.processEvents = $ListBox_1(($location_0[stackIndex] = 'InstanceDetailView.java:' + '222' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Process Events']));
    $location_0[stackIndex] = 'ListBox.java:' + '716' , this$static.processEvents.cellRenderer = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '223' , new InstanceDetailView$4);
    sourcePanel = $MosaicPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '238' , new MosaicPanel));
    $add_26(sourcePanel, this$static.processEvents, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '239' , new BoxLayoutData), VERTICAL_0));
    $location_0[stackIndex] = 'TabLayoutPanel.java:' + '330' , $insert_5(tabPanel, sourcePanel, 'Source', false, ($location_0[stackIndex] = 'LayoutComposite.java:' + '89' , dynamicCast(tabPanel.deck.widget, 182)).children_0.size_0);
    $location_0[stackIndex] = 'ScrollTabBar.java:' + '477' , $selectTab(tabPanel.tabBar.tabBar, 0);
    $add_26(layout, tabPanel, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '244' , new BoxLayoutData), BOTH));
    $WidgetWindowPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '246' , new WidgetWindowPanel), 'Process Instance Activity', layout, true);
    $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '251' , new Event_0), ($location_0[stackIndex] = 'GetProcessInstanceEventsAction.java:' + '19' , $clinit_975() , ID_7), inst.id_0)));
  }
   else if (this$static.isjBPMInstance) {
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceDetailView.java:' + '253' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
    header = $Label_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '257' , new Label), 'Instance: ' + inst.id_0);
    $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
    $add_26(layout, header, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '259' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    $add_26(layout, this$static.diagramView, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceDetailView.java:' + '261' , new BoxLayoutData), BOTH));
    $WidgetWindowPanel(($location_0[stackIndex] = 'InstanceDetailView.java:' + '263' , new WidgetWindowPanel), 'Process Instance Activity', layout, true);
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $formatResult(value){
  ...
  sbuffer = $StringBuffer(($location_0[stackIndex] = 'InstanceDetailView.java:' + '280' , new StringBuffer));
  st = $StringTokenizer(($location_0[stackIndex] = 'InstanceDetailView.java:' + '281' , new StringTokenizer), value, '~');
  $append_4(sbuffer, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '282' , $nextToken(st)) + ' : ');
  while ($location_0[stackIndex] = 'InstanceDetailView.java:' + '284' , $hasMoreTokens(st)) {
    $location_0[stackIndex] = 'StringBuffer.java:' + '115' , $append_0(sbuffer.data_0, '<br/>');
    $append_4(sbuffer, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '286' , $nextToken(st)));
  }
  returnTemp = ($location_0[stackIndex] = 'StringBuffer.java:' + '266' , $toString_1(sbuffer.data_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function $populateProcessInstanceEvents(this$static, refs){
  ...
  model = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '272' , $getModel(this$static.processEvents));
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(model.list);
  for ($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , value$iterator = ($location_0[stackIndex] = 'AbstractList.java:' + '291' , $listIterator(refs, 0)); value$iterator.currentNode != value$iterator.this$0.header;) {
    value = dynamicCast(($location_0[stackIndex] = 'InstanceDetailView.java:' + '274' , $next_9(value$iterator)), 238);
    $location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(model.list, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '275' , $formatResult(value.value_0)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $update_5(this$static, def, instance){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '319' , this$static.currentDefintion = def;
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '320' , this$static.currentInstance = instance;
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '322' , currentNodeName = instance.rootToken?instance.rootToken.currentNodeName:'n/a';
  values = ($location_0[stackIndex] = 'InstanceDetailView.java:' + '325' , initValues(_3Ljava_lang_String_2_classLit, 687, 1, [def.name_0, instance.id_0, '' + instance.lifecycle.current, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '329' , $format_2(this$static.dateFormat, instance.startDate)), currentNodeName]));
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '333' , $update_1(this$static.grid, values);
...
function setController_5(controller){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '303' , this.controller = controller;
  this.diagramView = $ActivityDiagramView(($location_0[stackIndex] = 'InstanceDetailView.java:' + '305' , new ActivityDiagramView));
  this.instanceDataView = $InstanceDataView(($location_0[stackIndex] = 'InstanceDetailView.java:' + '306' , new InstanceDataView));
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '308' , $addView(controller, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_962() , ID_2), this.diagramView);
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '309' , $addView(controller, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_976() , ID_8), this.instanceDataView);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_1002() , ID_11), $LoadActivityDiagramAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '310' , new LoadActivityDiagramAction)));
  this.isRiftsawInstance && ($location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, Lorg_jboss_bpm_console_client_process_LoadInstanceActivityImage_2_classLit.typeName, $LoadInstanceActivityImage(($location_0[stackIndex] = 'InstanceDetailView.java:' + '312' , new LoadInstanceActivityImage))) , undefined);
  $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_1014() , ID_17), $UpdateInstanceDataAction(($location_0[stackIndex] = 'InstanceDetailView.java:' + '314' , new UpdateInstanceDataAction)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_16(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '123' , $equals_4(diagramUrl, ''))) {
    ...
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '144' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_17(clickEvent){
  ...
  if (diagramUrl != null && !($location_0[stackIndex] = 'InstanceDetailView.java:' + '156' , $equals_4(diagramUrl, ''))) {
    ...
    if (selection) {
      $location_0[stackIndex] = 'InstanceDetailView.java:' + '161' , $createDiagramWindow(this.this$0, selection);
      $location_0[stackIndex] = 'InstanceDetailView.java:' + '162' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '163' , new Event_0), ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , $clinit_1002() , ID_11), selection)));
    }
  }
   else {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '169' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Incomplete deployment', 'No diagram associated with process');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceDetailView$3(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceDetailView.java:' + '179' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_18(clickEvent){
  ...
  if (this.this$0.currentInstance) {
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '185' , $createDataWindow(this.this$0, this.this$0.currentInstance);
    $location_0[stackIndex] = 'InstanceDetailView.java:' + '186' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , $Event(($location_0[stackIndex] = 'InstanceDetailView.java:' + '187' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , $clinit_1014() , ID_17), this.this$0.currentInstance.id_0)));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell_1(listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $setWidget_5(listBox, row, column, $HTML_0(($location_0[stackIndex] = 'InstanceDetailView.java:' + '230' , new HTML), item));
      break;
    default:throw $RuntimeException(($location_0[stackIndex] = 'InstanceDetailView.java:' + '233' , new RuntimeException), 'Should not happen!');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_985(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_985;
  $location_0[stackIndex] = 'InstanceListView.java:' + '73' , $clinit_985 = nullMethod;
...
function $InstanceListView(this$static){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '73' , $clinit_985();
...
function $bindData_0(this$static, instances){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '515' , model = ($location_0[stackIndex] = 'InstanceListView.java:' + '516' , $getModel(this$static.listBox));
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(model.list);
  $location_0[stackIndex] = 'InstanceListView.java:' + '519' , list = instances;
  for (inst$iterator = ($location_0[stackIndex] = 'InstanceListView.java:' + '520' , list.iterator_0()); $location_0[stackIndex] = 'InstanceListView.java:' + '520' , inst$iterator.hasNext();) {
    inst = dynamicCast(inst$iterator.next_0(), 231);
...
function $collectSignalableTokens(this$static, tokenParent, tokensToSignal){
  ...
  if (tokenParent.children_0) {
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '551' , token$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), tokenParent.children_0); token$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , token$iterator.this$0.size_1());) {
      token = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '551' , $next_6(token$iterator)), 239);
      token.canBeSignaled && ($location_0[stackIndex] = 'InstanceListView.java:' + '553' , tokensToSignal.add_0(token));
      $location_0[stackIndex] = 'InstanceListView.java:' + '556' , $collectSignalableTokens(this$static, token, tokensToSignal);
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $createSignalWindow(this$static){
  ...
  (new ArrayList).array = ($location_0[stackIndex] = 'ArrayList.java:' + '64' , initDim(_3Ljava_lang_Object_2_classLit, 684, 0, 0, 0));
  layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '565' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '565' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
  $location_0[stackIndex] = 'Element.java:' + '688' , layout.element['className'] = 'bpm-window-layout';
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '5px');
  toolBox = $MosaicPanel(($location_0[stackIndex] = 'InstanceListView.java:' + '569' , new MosaicPanel));
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(toolBox.element, 'padding', '0px');
  $location_0[stackIndex] = 'LayoutPanel.java:' + '297' , toolBox.widgetSpacing = 5;
  $setLayout_0(toolBox, $BoxLayout_1(($location_0[stackIndex] = 'InstanceListView.java:' + '573' , new BoxLayout), HORIZONTAL));
  toolBar = $ToolBar(($location_0[stackIndex] = 'InstanceListView.java:' + '575' , new ToolBar));
  $location_0[stackIndex] = 'InstanceListView.java:' + '576' , $add_28(toolBar, $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '577' , new Button), 'Signal', $InstanceListView$8(new InstanceListView$8, this$static)));
  $location_0[stackIndex] = 'InstanceListView.java:' + '625' , $add_28(toolBar, $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '626' , new Button), 'Close', $InstanceListView$9(new InstanceListView$9, this$static)));
  $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '640' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '640' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
  $add_26(layout, toolBox, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '642' , new BoxLayoutData), HORIZONTAL_0));
  header = $Label_0(($location_0[stackIndex] = 'InstanceListView.java:' + '644' , new Label), 'Known active nodes to signal: ');
  $location_0[stackIndex] = 'Element.java:' + '688' , header.element['className'] = 'bpm-label-header';
  $add_26(layout, header, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '646' , new BoxLayoutData), HORIZONTAL_0));
  this$static.listBoxTokens = $ListBox_1(($location_0[stackIndex] = 'InstanceListView.java:' + '648' , new ListBox_0), initValues(_3Ljava_lang_String_2_classLit, 687, 1, ['Node name', 'Signal ref']));
  $location_0[stackIndex] = 'ListBox.java:' + '716' , this$static.listBoxTokens.cellRenderer = ($location_0[stackIndex] = 'InstanceListView.java:' + '650' , new InstanceListView$10);
  $location_0[stackIndex] = 'InstanceListView.java:' + '667' , $renderSignalListBox(this$static, -1);
  $add_26(layout, this$static.listBoxTokens, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '668' , new BoxLayoutData), BOTH));
  headerSignalRef = $Label_0(($location_0[stackIndex] = 'InstanceListView.java:' + '670' , new Label), 'Signal ref');
  $location_0[stackIndex] = 'Element.java:' + '688' , headerSignalRef.element['className'] = 'bpm-label-header';
  $add_26(layout, headerSignalRef, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '672' , new BoxLayoutData), HORIZONTAL_0));
  this$static.signalRef = $TextBox(($location_0[stackIndex] = 'InstanceListView.java:' + '674' , new TextBox));
  $location_0[stackIndex] = 'FocusWidget.java:' + '103' , $addDomHandler(this$static.signalRef, $InstanceListView$11(($location_0[stackIndex] = 'InstanceListView.java:' + '675' , new InstanceListView$11), this$static), ($location_0[stackIndex] = 'FocusWidget.java:' + '103' , $clinit_136() , ($location_0[stackIndex] = 'FocusEvent.java:' + '27' , $clinit_136()) , TYPE_3));
  $add_26(layout, this$static.signalRef, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '685' , new BoxLayoutData), BOTH));
  headerSignals = $Label_0(($location_0[stackIndex] = 'InstanceListView.java:' + '687' , new Label), 'Event data');
  $location_0[stackIndex] = 'Element.java:' + '688' , headerSignals.element['className'] = 'bpm-label-header';
  $add_26(layout, headerSignals, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '689' , new BoxLayoutData), HORIZONTAL_0));
  this$static.eventData = $TextBox(($location_0[stackIndex] = 'InstanceListView.java:' + '691' , new TextBox));
  $add_26(layout, this$static.eventData, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '693' , new BoxLayoutData), BOTH));
  this$static.signalWindowPanel = $WidgetWindowPanel(($location_0[stackIndex] = 'InstanceListView.java:' + '695' , new WidgetWindowPanel), 'Signal process', layout, false);
  $location_0[stackIndex] = 'WidgetWindowPanel.java:' + '79' , $setContentSize_1(this$static.signalWindowPanel.window_0, $Dimension_1(($location_0[stackIndex] = 'InstanceListView.java:' + '699' , new Dimension), 500, 400));
  $stackDepth_0 = stackIndex - 1;
}
...
function $getSelection(this$static){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '450' , selection = null;
  ($location_0[stackIndex] = 'InstanceListView.java:' + '451' , $getSelectedIndex_0(this$static.listBox)) != -1 && (selection = dynamicCast($getItem_0(this$static.listBox, ($location_0[stackIndex] = 'InstanceListView.java:' + '452' , $getSelectedIndex_0(this$static.listBox))), 231));
  $stackDepth_0 = stackIndex - 1;
  return selection;
}
...
function $initialize_1(this$static){
  ...
  if (!this$static.isInitialized) {
    this$static.instanceList = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '146' , new MosaicPanel), ($location_0[stackIndex] = 'InstanceListView.java:' + '146' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_802() , VERTICAL))));
    ...
    this$static.refreshBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '213' , new Button), 'Refresh', $InstanceListView$3(new InstanceListView$3, this$static));
    ...
    this$static.startBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '229' , new Button), 'Start', $InstanceListView$4(new InstanceListView$4, this$static));
    this$static.terminateBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '283' , new Button), 'Terminate', $InstanceListView$5(new InstanceListView$5, this$static));
    this$static.deleteBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '325' , new Button), 'Delete', $InstanceListView$6(new InstanceListView$6, this$static));
    this$static.signalBtn = $Button_1(($location_0[stackIndex] = 'InstanceListView.java:' + '370' , new Button), 'Signal', $InstanceListView$7(new InstanceListView$7, this$static));
    if (!this$static.isRiftsawInstance) {
      $location_0[stackIndex] = 'InstanceListView.java:' + '389' , $add_28(toolBar, this$static.startBtn);
      $location_0[stackIndex] = 'InstanceListView.java:' + '390' , $add_28(toolBar, this$static.signalBtn);
      $location_0[stackIndex] = 'InstanceListView.java:' + '391' , $add_28(toolBar, this$static.deleteBtn);
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '399' , $add_28(toolBar, this$static.terminateBtn);
    $location_0[stackIndex] = 'Element.java:' + '638' , this$static.terminateBtn.element['disabled'] = !false;
    $add_26(toolBox, toolBar, ($location_0[stackIndex] = 'InstanceListView.java:' + '402' , $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '402' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_804() , HORIZONTAL_0))));
    $add_26(this$static.instanceList, toolBox, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '405' , new BoxLayoutData), HORIZONTAL_0));
    $add_26(this$static.instanceList, this$static.listBox, $BoxLayoutData_4(($location_0[stackIndex] = 'InstanceListView.java:' + '406' , new BoxLayoutData), BOTH));
    !!this$static.cachedInstances && ($location_0[stackIndex] = 'InstanceListView.java:' + '426' , $bindData_0(this$static, this$static.cachedInstances));
    layout = $MosaicPanel_0(($location_0[stackIndex] = 'InstanceListView.java:' + '429' , new MosaicPanel), $BorderLayout(new BorderLayout));
    $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(layout.element, 'padding', '0px');
    $add_26(layout, this$static.instanceList, ($location_0[stackIndex] = 'InstanceListView.java:' + '431' , $BorderLayoutData_1(($location_0[stackIndex] = 'InstanceListView.java:' + '431' , new BorderLayoutData), ($location_0[stackIndex] = 'BorderLayout.java:' + '199' , $clinit_795() , CENTER_1))));
    detailsView = $InstanceDetailView(($location_0[stackIndex] = 'InstanceListView.java:' + '434' , new InstanceDetailView));
    $location_0[stackIndex] = 'InstanceListView.java:' + '435' , $addView(this$static.controller, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9), detailsView);
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1015() , ID_18), ($location_0[stackIndex] = 'InstanceListView.java:' + '436' , new UpdateInstanceDetailAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'ClearInstancesAction.java:' + '32' , $clinit_963() , ID_3), ($location_0[stackIndex] = 'InstanceListView.java:' + '437' , new ClearInstancesAction));
    $location_0[stackIndex] = 'Controller.java:' + '106' , $put_0(this$static.controller.actions, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), $SignalExecutionAction(($location_0[stackIndex] = 'InstanceListView.java:' + '438' , new SignalExecutionAction)));
    $add_26(layout, detailsView, $BorderLayoutData_5(($location_0[stackIndex] = 'InstanceListView.java:' + '439' , new BorderLayoutData), SOUTH_0, 10, 200));
    $location_0[stackIndex] = 'InstanceListView.java:' + '441' , $add_25(this$static.panel, layout);
    $location_0[stackIndex] = 'InstanceListView.java:' + '443' , this$static.isInitialized = true;
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $isSignalable(this$static, processInstance){
  ...
  this$static.tokensToSignal = $ArrayList(($location_0[stackIndex] = 'InstanceListView.java:' + '531' , new ArrayList));
  !!processInstance.rootToken && processInstance.rootToken.canBeSignaled?($location_0[stackIndex] = 'InstanceListView.java:' + '535' , $add_7(this$static.tokensToSignal, processInstance.rootToken)):!!processInstance.rootToken && !!processInstance.rootToken.children_0 && ($location_0[stackIndex] = 'InstanceListView.java:' + '539' , $collectSignalableTokens(this$static, processInstance.rootToken, this$static.tokensToSignal));
...
function $provideWidget_2(this$static, callback){
  ...
  this$static.appContext = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '121' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.panel.element, 'padding', '0px');
  $addView(dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '128' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 166), ID_10, this$static);
  $location_0[stackIndex] = 'InstanceListView.java:' + '129' , $initialize_1(this$static);
  $location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '6' , $clinit_941();
  !greenIcon && (greenIcon = $ImageResourcePrototype(($location_0[stackIndex] = 'org_jboss_bpm_console_client_icons_ConsoleIconBundle_default_StaticClientBundleGenerator.java:' + '99' , new ImageResourcePrototype), internedUrl0_2, 266, 10, 10, 10));
...
function $renderSignalListBox(this$static, i){
  ...
  i > -1 && ($location_0[stackIndex] = 'InstanceListView.java:' + '706' , $remove_7(this$static.tokensToSignal, i));
  $location_0[stackIndex] = 'DefaultListModel.java:' + '61' , $clear_5(($location_0[stackIndex] = 'InstanceListView.java:' + '709' , $getModel(this$static.listBoxTokens)).list);
  if (this$static.tokensToSignal.size_0 != 0) {
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '713' , token$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this$static.tokensToSignal); token$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , token$iterator.this$0.size_1());) {
      token = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '713' , $next_6(token$iterator)), 239);
      $location_0[stackIndex] = 'DefaultListModel.java:' + '45' , $add_6(($location_0[stackIndex] = 'InstanceListView.java:' + '714' , $getModel(this$static.listBoxTokens)).list, token);
    }
  }
...
function $renderUpdate(this$static){
  ...
  if (this$static.isInitialized) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '497' , $bindData_0(this$static, this$static.cachedInstances);
    $location_0[stackIndex] = 'InstanceListView.java:' + '500' , $handleEvent(this$static.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '501' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '501' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1015() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '502' , new InstanceEvent), this$static.currentDefinition, null))));
...
function $update_6(this$static, data){
  ...
  this$static.currentDefinition = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '481' , data[0]), 230);
  this$static.cachedInstances = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '482' , data[1]), 170);
  $location_0[stackIndex] = 'InstanceListView.java:' + '485' , $renderUpdate(this$static);
  $stackDepth_0 = stackIndex - 1;
}
...
function setController_6(controller){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '463' , this.controller = controller;
  $stackDepth_0 = stackIndex - 1;
}
...
function setLoading_0(isLoading){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '490' , on(this.instanceList, isLoading);
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell_2(this$static, listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'InstanceListView.java:' + '161' , $setText_6(listBox, row, column, item.id_0);
      break;
    case 1:
      $location_0[stackIndex] = 'InstanceListView.java:' + '164' , $setText_6(listBox, row, column, item.lifecycle.current.name_0);
      break;
    case 2:
      d = item.startDate?($location_0[stackIndex] = 'InstanceListView.java:' + '167' , $format_2(this$static.this$0.dateFormat, item.startDate)):'';
      $location_0[stackIndex] = 'ListBox.java:' + '913' , $setText_7(listBox.dataTable, (trElem = dynamicCastJso(($location_0[stackIndex] = 'ListBox.java:' + '925' , $get_6(listBox.rowsInModelOrder, row))) , trElem.sectionRowIndex - 1), column, d);
      break;
...
function renderCell_3(p0, p1, p2, p3){
  ...
  $renderCell_2(this, p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 231)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $renderCell_3(listBox, row, column, item){
  ...
  switch (column) {
    case 0:
      $location_0[stackIndex] = 'InstanceListView.java:' + '655' , $setText_6(listBox, row, column, item.currentNodeName);
      break;
    case 1:
      $location_0[stackIndex] = 'InstanceListView.java:' + '658' , $setText_6(listBox, row, column, item.name_0);
      break;
    default:throw $RuntimeException(($location_0[stackIndex] = 'InstanceListView.java:' + '661' , new RuntimeException), 'Unexpected column size');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function renderCell_4(p0, p1, p2, p3){
  ...
  $renderCell_3(p0, p1, p2, ($location_0[stackIndex] = 'com.google.gwt.dev.jjs.impl.GenerateJavaAST:' + '0' , dynamicCast(p3, 239)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceListView$11(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '675' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onFocus_0(event_0){
  ...
  ($location_0[stackIndex] = 'InstanceListView.java:' + '679' , $getSelectedIndex_0(this.this$0.listBox)) != -1 && $setItemSelected_0(this.this$0.listBoxTokens, ($location_0[stackIndex] = 'InstanceListView.java:' + '680' , $getSelectedIndex_0(this.this$0.listBox)), false);
  $stackDepth_0 = stackIndex - 1;
}
...
function onRowSelection_0(rowSelectionEvent){
  ...
  if (index != -1) {
    item = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '184' , $getItem_0(this.this$0.listBox, index)), 231);
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '196' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '197' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '197' , new Event_0), ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '33' , $clinit_1015() , ID_18), $InstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '198' , new InstanceEvent), this.this$0.currentDefinition, item))));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_19(clickEvent){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '216' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '217' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '217' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_0(doIt){
  ...
  if (doIt) {
    ...
    if (hasForm) {
      ...
      $location_0[stackIndex] = 'InstanceListView.java:' + '266' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '267' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '267' , new Event_0), ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '40' , $clinit_1011() , ID_14), this.this$1.this$0.currentDefinition)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onWindowClosed(){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '255' , $handleEvent(this.this$2.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '256' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '256' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.this$2.this$1.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function onClick_21(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '287' , $getSelection(this.this$0)) {
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '318' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function onResult_1(doIt){
  ...
  if (doIt) {
    ...
    if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED)) {
      $location_0[stackIndex] = 'InstanceListView.java:' + '300' , $clinit_691();
      $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Info', 'Process is already completed');
    }
     else {
      $location_0[stackIndex] = 'InstanceListView.java:' + '303' , $setState_3(selection, ENDED);
      $location_0[stackIndex] = 'InstanceListView.java:' + '304' , $setEndResult(selection, ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '50' , $clinit_955() , OBSOLETE));
      $location_0[stackIndex] = 'InstanceListView.java:' + '305' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '306' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '306' , new Event_0), ($location_0[stackIndex] = 'StateChangeAction.java:' + '44' , $clinit_1012() , ID_15), selection)));
    }
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceListView$6(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '325' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_22(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '329' , $getSelection(this.this$0)) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '331' , confirm_1('Delete instance', 'Deleting this instance will remove any history information and associated tasks as well.', $InstanceListView$6$1(($location_0[stackIndex] = 'InstanceListView.java:' + '333' , new InstanceListView$6$1), this));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '364' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceListView$6$1(this$static, this$1){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '333' , this$static.this$1 = this$1;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onResult_2(doIt){
  ...
  if (doIt) {
    try {
      selection = ($location_0[stackIndex] = 'InstanceListView.java:' + '341' , $getSelection(this.this$1.this$0));
      if (selection.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED)) {
        $location_0[stackIndex] = 'InstanceListView.java:' + '343' , $clinit_691();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Info', 'Process is already completed');
      }
       else {
        $location_0[stackIndex] = 'InstanceListView.java:' + '345' , $setState_3(selection, ENDED);
        $location_0[stackIndex] = 'InstanceListView.java:' + '347' , $handleEvent(this.this$1.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '348' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '348' , new Event_0), ($location_0[stackIndex] = 'DeleteInstanceAction.java:' + '42' , $clinit_974() , ID_6), selection)));
      }
    }
     catch ($e0) {
      $e0 = ($location_0[stackIndex] = 'InstanceListView.java:' + '354' , caught_0($e0));
      $stackDepth_0 = stackIndex;
      if (instanceOf($e0, 8)) {
        e = $e0;
        $location_0[stackIndex] = 'MessageBox.java:' + '110' , $clinit_691();
        $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Warning', ($location_0[stackIndex] = 'InstanceListView.java:' + '355' , e.getMessage()));
      }
       else 
        throw $e0;
    }
...
function $InstanceListView$7(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '370' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_23(clickEvent){
  ...
  if ($location_0[stackIndex] = 'InstanceListView.java:' + '375' , $getSelection(this.this$0)) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '377' , $createSignalWindow(this.this$0);
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '381' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Missing selection', 'Please select an instance');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceListView$8(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '577' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_24(clickEvent){
  ...
  selectedToken = ($location_0[stackIndex] = 'InstanceListView.java:' + '581' , $getSelectedIndex_0(this.this$0.listBoxTokens));
  if (selectedToken != -1 && ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '585' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Multi selection', 'Known active nodes and signal ref (text box) is given, please choose only one of them');
  }
   else if (selectedToken != -1) {
    $location_0[stackIndex] = 'InstanceListView.java:' + '590' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '591' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '591' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '592' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '592' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), dynamicCast($getItem_0(this.this$0.listBoxTokens, selectedToken), 239), ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), selectedToken)))));
  }
   else if (($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.signalRef.element, 'value')).length > 0) {
    token = $TokenReference(($location_0[stackIndex] = 'InstanceListView.java:' + '596' , new TokenReference));
    $location_0[stackIndex] = 'TokenReference.java:' + '57' , token.id_0 = ($location_0[stackIndex] = 'InstanceListView.java:' + '597' , $getSelection(this.this$0)).id_0;
    ...
    $location_0[stackIndex] = 'InstanceListView.java:' + '599' , foundMatch = -1;
    $location_0[stackIndex] = 'InstanceListView.java:' + '600' , index = 0;
    for ($location_0[stackIndex] = 'InstanceListView.java:' + '602' , ref$iterator = $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), this.this$0.tokensToSignal); ref$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , ref$iterator.this$0.size_1());) {
      ref = dynamicCast(($location_0[stackIndex] = 'InstanceListView.java:' + '602' , $next_6(ref$iterator)), 239);
      if ($location_0[stackIndex] = 'InstanceListView.java:' + '604' , $equals_4(ref.name_0, token.name_0)) {
        $location_0[stackIndex] = 'InstanceListView.java:' + '605' , foundMatch = index;
        break;
      }
      $location_0[stackIndex] = 'InstanceListView.java:' + '608' , ++index;
    }
    $location_0[stackIndex] = 'InstanceListView.java:' + '611' , $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '612' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '612' , new Event_0), ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '42' , $clinit_1009() , ID_13), ($location_0[stackIndex] = 'InstanceListView.java:' + '613' , $SignalInstanceEvent(($location_0[stackIndex] = 'InstanceListView.java:' + '613' , new SignalInstanceEvent), this.this$0.currentDefinition, $getSelection(this.this$0), token, ($location_0[stackIndex] = 'DOM.java:' + '760' , $getPropertyString(this.this$0.eventData.element, 'value')), foundMatch)))));
  }
   else {
    $location_0[stackIndex] = 'InstanceListView.java:' + '616' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Incomplete selection', 'Please select element you want to signal');
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $InstanceListView$9(this$static, this$0){
  ...
  $location_0[stackIndex] = 'InstanceListView.java:' + '626' , this$static.this$0 = this$0;
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function onClick_25(clickEvent){
  ...
  $handleEvent(this.this$0.controller, ($location_0[stackIndex] = 'InstanceListView.java:' + '632' , $Event(($location_0[stackIndex] = 'InstanceListView.java:' + '632' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.this$0.currentDefinition)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $parseObject(this$static, root, topLevel){
  ...
  for ($location_0[stackIndex] = 'JSONTree.java:' + '83' , innerKey$iterator = ($location_0[stackIndex] = 'AbstractList.java:' + '278' , $AbstractList$IteratorImpl(($location_0[stackIndex] = 'AbstractList.java:' + '278' , new AbstractList$IteratorImpl), ($location_0[stackIndex] = 'Arrays.java:' + '99' , $Arrays$ArrayList(($location_0[stackIndex] = 'Arrays.java:' + '99' , new Arrays$ArrayList), ($location_0[stackIndex] = 'JSONTree.java:' + '83' , $keySet_0(rootJSO)).val$keys)))); innerKey$iterator.i < ($location_0[stackIndex] = 'AbstractList.java:' + '38' , innerKey$iterator.this$0.size_1());) {
    ...
    jsonValue = ($location_0[stackIndex] = 'JSONTree.java:' + '85' , $get_4(rootJSO, innerKey));
...
function $parseValue(root, key, jsonValue){
  ...
  if ($location_0[stackIndex] = 'JSONTree.java:' + '50' , jsonValue.isBoolean()) {
    ...
    $addItem_2(treeItem, ($location_0[stackIndex] = 'JSONBoolean.java:' + '83' , $clinit_521() , '' + ($location_0[stackIndex] = 'JSONTree.java:' + '53' , jsonValue.isBoolean()).value_0));
  }
...
_.typeId$ = 455;
function $clinit_1002(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1002;
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_1002 = nullMethod;
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '43' , ID_11 = Lorg_jboss_bpm_console_client_process_LoadActivityDiagramAction_2_classLit.typeName;
  $stackDepth_0 = stackIndex - 1;
}
...
function $LoadActivityDiagramAction(this$static){
  ...
  $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '41' , $clinit_1002();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_5(event_0){
  ...
  inst = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '52' , dynamicCast(event_0, 231));
  returnTemp = $getActiveNodeInfoURL(($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '53' , getInstance_2() , inst.id_0));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}

function handleSuccessfulResponse_3(controller, event_0, response){
  var activeNodeInfos, inst, view, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = handleSuccessfulResponse_3;
  inst = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '64' , dynamicCast(event_0, 231));
  if (inst.lifecycle.current == ($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED) || response.val$xmlHttpRequest.responseText.length == 0) {
    $location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '66' , $clinit_691();
    $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Info', 'Process is already completed');
  }
   else {
    activeNodeInfos = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '68' , parseActiveNodeInfo(response.val$xmlHttpRequest.responseText));
    view = ($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '70' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_962() , ID_2))), 167), 240));
    $update_2(view, $ActivityDiagramResultEvent(($location_0[stackIndex] = 'LoadActivityDiagramAction.java:' + '71' , new ActivityDiagramResultEvent), $getProcessImageURL((getInstance_2() , inst.definitionId)), activeNodeInfos));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1003(){
  ...
  $location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '28' , $clinit_1003 = nullMethod;
...
function $LoadInstanceActivityImage(this$static){
  ...
  $location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '28' , $clinit_1003();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_6(event_0){
  ...
  inst = ($location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '39' , dynamicCast(event_0, 231));
...
function handleSuccessfulResponse_4(controller, event_0, response){
  ...
  inst = ($location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '51' , dynamicCast(event_0, 231));
  view = ($location_0[stackIndex] = 'LoadInstanceActivityImage.java:' + '54' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'ActivityDiagramView.java:' + '43' , $clinit_962() , ID_2))), 167), 240));
  ...
  $location_0[stackIndex] = 'LayoutPanel.java:' + '391' , $insert_0(view, html, view.children_0.size_0);
...
function $provideWidget_3(this$static, callback){
  ...
  dynamicCast(($location_0[stackIndex] = 'MergedProcessView.java:' + '44' , get_16(Lcom_mvc4g_client_Controller_2_classLit)), 166);
  this$static.panel = $MosaicPanel(($location_0[stackIndex] = 'MergedProcessView.java:' + '46' , new MosaicPanel));
  $location_0[stackIndex] = 'LayoutPanel.java:' + '289' , setStyleAttribute_0(this$static.panel.element, 'padding', '0px');
  this$static.definitionView = ($location_0[stackIndex] = 'DefinitionListView.java:' + '61' , $clinit_964() , ($location_0[stackIndex] = 'MergedProcessView.java:' + '49' , new DefinitionListView));
...
function $clinit_1009(){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '40' , $clinit_1009 = nullMethod;
...
function $SignalExecutionAction(this$static){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '40' , $clinit_1009();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_7(event_0){
  ...
  def = ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '51' , dynamicCast(event_0, 241));
...
function handleSuccessfulResponse_5(controller, event_0, response){
  ...
  def = ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '70' , dynamicCast(event_0, 241));
  view = ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '71' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
...
function $clinit_1010(){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '76' , $clinit_1010 = nullMethod;
  $clinit_43();
  $stackDepth_0 = stackIndex - 1;
}
...
function $SignalExecutionAction$1(this$static, val$controller, val$def){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '76' , $clinit_1010();
  this$static.val$controller = val$controller;
...
function run_19(){
  ...
  $location_0[stackIndex] = 'SignalExecutionAction.java:' + '82' , $handleEvent(this.val$controller, ($location_0[stackIndex] = 'SignalExecutionAction.java:' + '83' , $Event(($location_0[stackIndex] = 'SignalExecutionAction.java:' + '83' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), this.val$def.definition)));
  $stackDepth_0 = stackIndex - 1;
}
...
_.val$controller = null;
_.val$def = null;
function $clinit_1011(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1011;
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '38' , $clinit_1011 = nullMethod;
...
function $StartNewInstanceAction(this$static){
  ...
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '38' , $clinit_1011();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_697(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_697;
  $stackDepth_0 = stackIndex - 1;
...
function getUrl_8(event_0){
  ...
  def = ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '49' , dynamicCast(event_0, 230));
...
function handleSuccessfulResponse_6(controller, event_0, response){
  ...
  def = ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '60' , dynamicCast(event_0, 230));
  $location_0[stackIndex] = 'StartNewInstanceAction.java:' + '63' , $handleEvent(controller, ($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '64' , $Event(($location_0[stackIndex] = 'StartNewInstanceAction.java:' + '64' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1012(){
  ...
  $location_0[stackIndex] = 'StateChangeAction.java:' + '42' , $clinit_1012 = nullMethod;
...
function $StateChangeAction(this$static){
  ...
  $location_0[stackIndex] = 'StateChangeAction.java:' + '42' , $clinit_1012();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}

function getClass_698(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = getClass_698;
  $stackDepth_0 = stackIndex - 1;
...
function getUrl_9(event_0){
  ...
  inst = ($location_0[stackIndex] = 'StateChangeAction.java:' + '53' , dynamicCast(event_0, 231));
  if (($location_0[stackIndex] = 'ProcessInstanceRef.java:' + '45' , $clinit_956() , ENDED) == inst.lifecycle.current) {
...
function handleError_1(url, t){
  ...
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'StateChangeAction.java:' + '81' , $clinit_691();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}
...
function handleSuccessfulResponse_7(controller, event_0, response){
  ...
  view = ($location_0[stackIndex] = 'StateChangeAction.java:' + '67' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $location_0[stackIndex] = 'StateChangeAction.java:' + '68' , def = view.currentDefinition;
  $handleEvent(controller, ($location_0[stackIndex] = 'StateChangeAction.java:' + '71' , $Event(($location_0[stackIndex] = 'StateChangeAction.java:' + '71' , new Event_0), ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '47' , $clinit_1016() , ID_19), def)));
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1013(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1013;
  $location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '46' , $clinit_1013 = nullMethod;
...
function $UpdateDefinitionsAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '46' , $clinit_1013();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_0(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '69' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_964() , ID_4))), 167), 242));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleSuccessfulResponse_8(controller, event_0, response){
  ...
  this.appContext = dynamicCast(($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '74' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  ...
  if (isjBPMInstance) {
    view = ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '78' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'DefinitionListView.java:' + '63' , $clinit_964() , ID_4))), 167), 242));
    if (view) {
      ...
      $update_4(view, ($location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '83' , initValues(_3Ljava_lang_Object_2_classLit, 684, 0, [definitions])));
    ...
    $location_0[stackIndex] = 'UpdateDefinitionsAction.java:' + '87' , throwClassCastExceptionUnlessNull(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, Lorg_jboss_bpm_console_client_process_v2_Explorer_2_classLit.typeName)), 167));
  }
  $stackDepth_0 = stackIndex - 1;
}
...
function $clinit_1014(){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_1014 = nullMethod;
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '42' , ID_17 = Lorg_jboss_bpm_console_client_process_UpdateInstanceDataAction_2_classLit.typeName;
  $stackDepth_0 = stackIndex - 1;
}
...
function $UpdateInstanceDataAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '39' , $clinit_1014();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getUrl_11(event_0){
  ...
  id = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '51' , dynamicCast(event_0, 1));
  returnTemp = $getInstanceDataURL(($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '52' , getInstance_2() , id));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function handleError_2(url, t){
  ...
  message = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '71' , t.getMessage());
  message = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '73' , $replaceFirst(message, 'HTTP \\d*: ', ''));
  $location_0[stackIndex] = 'ConsoleLog.java:' + '41' , $clinit_24();
  $location_0[stackIndex] = 'Log.java:' + '651' , $warn(impl, 'Server reported following warning: ' + message + ' for url ' + url, null);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '76' , $clinit_691();
  $location_0[stackIndex] = 'MessageBox.java:' + '111' , alert_2(($location_0[stackIndex] = 'MessageBox.java:' + '60' , $clinit_700() , ALERT), 'Status information', message);
  $stackDepth_0 = stackIndex - 1;
}

function handleSuccessfulResponse_9(controller, event_0, response){
  var messageDom, view, xml, stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = handleSuccessfulResponse_9;
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '62' , dynamicCast(event_0, 1);
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '63' , xml = response.val$xmlHttpRequest.responseText;
  $location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , messageDom = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '64' , $clinit_495() , ($location_0[stackIndex] = 'XMLParser.java:' + '47' , $parse(impl_1, xml)));
  view = ($location_0[stackIndex] = 'UpdateInstanceDataAction.java:' + '65' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDataView.java:' + '48' , $clinit_976() , ID_8))), 167), 243));
...
_.typeId$ = 465;
var ID_17;
function $clinit_1015(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1015;
  $location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '31' , $clinit_1015 = nullMethod;
...
function execute_38(controller, object){
  ...
  event_0 = ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '37' , dynamicCast(object, 244));
  view = ($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '39' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceDetailView.java:' + '58' , $clinit_979() , ID_9))), 167), 235));
  event_0.instance?($location_0[stackIndex] = 'UpdateInstanceDetailAction.java:' + '42' , $update_5(view, event_0.definition, event_0.instance)):($location_0[stackIndex] = 'PropertyGrid.java:' + '79' , $initReset(view.grid) , ($location_0[stackIndex] = 'InstanceDetailView.java:' + '344' , view.currentDefintion = null) , ($location_0[stackIndex] = 'InstanceDetailView.java:' + '345' , view.currentInstance = null) , ($location_0[stackIndex] = 'Element.java:' + '638' , view.diagramBtn.element['disabled'] = !false) , view.instanceDataBtn.element['disabled'] = !false , undefined);
  $stackDepth_0 = stackIndex - 1;
}
...
_.typeId$ = 466;
var ID_18;
function $clinit_1016(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_1016;
  $location_0[stackIndex] = 'UpdateInstancesAction.java:' + '45' , $clinit_1016 = nullMethod;
...
function $UpdateInstancesAction(this$static){
  ...
  $location_0[stackIndex] = 'UpdateInstancesAction.java:' + '45' , $clinit_1016();
  dynamicCast(($location_0[stackIndex] = 'AbstractRESTAction.java:' + '44' , get_16(Lorg_jboss_bpm_console_client_ApplicationContext_2_classLit)), 224);
  $stackDepth_0 = stackIndex - 1;
  return this$static;
}
...
function getDataDriven_1(controller){
  ...
  returnTemp = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '68' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  $stackDepth_0 = stackIndex - 1;
  return returnTemp;
}
...
function getUrl_12(event_0){
  ...
  def = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '56' , dynamicCast(event_0, 230));
...
function handleSuccessfulResponse_10(controller, event_0, response){
  ...
  def = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '75' , dynamicCast(event_0, 230));
  ...
  view = ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '77' , dynamicCast(dynamicCast(($location_0[stackIndex] = 'Controller.java:' + '67' , $get_8(controller.views, ($location_0[stackIndex] = 'InstanceListView.java:' + '75' , $clinit_985() , ID_10))), 167), 234));
  !!view && $update_6(view, ($location_0[stackIndex] = 'UpdateInstancesAction.java:' + '78' , initValues(_3Ljava_lang_Object_2_classLit, 684, 0, [def, instances])));
  $location_0[stackIndex] = 'Log.java:' + '354' , $clinit_24();
...
function getChildElements(childNodes){
  ...
  for ($location_0[stackIndex] = 'DOMUtil.java:' + '39' , i = 0; i < ($location_0[stackIndex] = 'DOMUtil.java:' + '39' , childNodes.getLength()); $location_0[stackIndex] = 'DOMUtil.java:' + '39' , ++i) {
    ...
    if (($location_0[stackIndex] = 'XMLParserImpl.java:' + '141' , $clinit_510() , ($location_0[stackIndex] = 'XMLParserImpl.java:' + '142' , out = n.jsObject.nodeType) , out == null?-1:out) != 1)
      continue;
    else 
