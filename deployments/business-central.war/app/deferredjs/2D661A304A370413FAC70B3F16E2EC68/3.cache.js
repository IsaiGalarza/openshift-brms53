...
function onLoad_1(){
  ...
  instance_4 = ($location_0[stackIndex] = 'AsyncLoader3.java:' + '5' , $clinit_264() , ($location_0[stackIndex] = 'AsyncLoader3.java:' + '22' , new AsyncLoader3));
...
function $clinit_911(){
  var stackIndex;
  $stack_0[stackIndex = ++$stackDepth_0] = $clinit_911;
  $location_0[stackIndex] = 'ServerStatusView.java:' + '44' , $clinit_911 = nullMethod;
...
function $ServerStatusView(this$static){
  ...
  $location_0[stackIndex] = 'ServerStatusView.java:' + '59' , $clinit_911();
...
function $provideWidget_0(this$static, callback){
  ...
  this$static.layoutPanel = $MosaicPanel_0(($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , new MosaicPanel), ($location_0[stackIndex] = 'ServerStatusView.java:' + '68' , $BoxLayout_1(new BoxLayout, ($location_0[stackIndex] = 'BoxLayout.java:' + '170' , $clinit_791() , VERTICAL))));
  console = $HeaderLabel(($location_0[stackIndex] = 'ServerStatusView.java:' + '71' , new HeaderLabel), 'Console Info');
  $add_26(this$static.layoutPanel, console, ($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , $BoxLayoutData_4(($location_0[stackIndex] = 'ServerStatusView.java:' + '72' , new BoxLayoutData), ($location_0[stackIndex] = 'BoxLayoutData.java:' + '30' , $clinit_793() , HORIZONTAL_0))));
...
function $update_0(this$static, status_0){
  ...
  for ($location_0[stackIndex] = 'ServerStatusView.java:' + '130' , row = 0; row < status_0.plugins.size_0; $location_0[stackIndex] = 'ServerStatusView.java:' + '130' , ++row) {
    p = dynamicCast(($location_0[stackIndex] = 'ServerStatusView.java:' + '132' , $get_5(status_0.plugins, row)), 228);
    ...
    type != null && $setInnerText_0(($location_0[stackIndex] = 'Element.java:' + '621' , $clinit_82() , td), type);
